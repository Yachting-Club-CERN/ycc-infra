...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."COMMITTEE_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 980 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."COMMITTEE_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence EMAIL_TEMPLATE_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."EMAIL_TEMPLATE_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 303 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."EMAIL_TEMPLATE_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence FEESRECORDS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."FEESRECORDS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 25689 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."FEESRECORDS_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence HOLIDAYS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."HOLIDAYS_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 301 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."LOTTERY_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 5171 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."LOTTERY_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence MEMBERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."MEMBERS_ID"  MINVALUE 1000 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 7568 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."MEMBERS_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence REGATTAS_EXT_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."REGATTAS_EXT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 3141 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."REGATTA_PARTICIPATION_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 33056 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."REGATTA_PARTICIPATION_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence REGATTA_PROFILES_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."REGATTA_PROFILES_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 16205 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."S_EMAIL_QUEUE"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 53991 CACHE 10 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_EMAIL_QUEUE" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence S_IMPORTANT_DATES
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."S_IMPORTANT_DATES"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 321 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_IMPORTANT_DATES" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence S_LOTTERY_RESULTS
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."S_LOTTERY_RESULTS"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 10441 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_LOTTERY_RESULTS" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence TEACHERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."TEACHERS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1844 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
--  DDL for Sequence YCC_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."YCC_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 127 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table ADMIN
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 LOB ("DATA") STORE AS SECUREFILE (
  TABLESPACE "DATA02" ENABLE STORAGE IN ROW CHUNK 8192
...
--------------------------------------------------------
  ...
  CREATE TABLE "YCC"."BOAT_MAINTAINER" 
   (	"ID" NUMBER(*,0), 
	"BOAT_ID" NUMBER(*,0), 
	"MEMBER_ID" NUMBER(*,0), 
	"PRIORITY" NUMBER(*,0), 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Table CLUB_EVENT
--------------------------------------------------------

  CREATE TABLE "YCC"."CLUB_EVENT" 
   (	"ID" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"MULTIPLE_CHOICES" VARCHAR2(50 CHAR)
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Table CLUB_EVENT_PARTICIPANT
--------------------------------------------------------

  CREATE TABLE "YCC"."CLUB_EVENT_PARTICIPANT" 
   (	"ID" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"MEMBER_ID" NUMBER(*,0), 
	"POSITION" NUMBER(*,0), 
	"PRIORITY" NUMBER(*,0), 
	"AS_SKIPPER" NUMBER(*,0), 
	"AS_UPGRADED_SKIPPER" NUMBER(*,0), 
	"CREATED" DATE, 
	"MODIFIED" DATE, 
	"PREFERENCE" NUMBER(*,0), 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Table CLUB_EVENT_RESOURCE
--------------------------------------------------------

  CREATE TABLE "YCC"."CLUB_EVENT_RESOURCE" 
   (	"ID" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"ACTIVE" NUMBER(*,0), 
	"NAME" VARCHAR2(50 CHAR), 
	"DESCRIPTION" VARCHAR2(200 CHAR), 
	"CAPACITY" NUMBER(*,0), 
	"SKIPPER_LICENCE" VARCHAR2(10 CHAR), 
	"ALLOW_UPGRADE_TO_SKIPPER" NUMBER(*,0), 
	"BOAT_ID" NUMBER(*,0), 
	"SESSION_ID" NUMBER(*,0)
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Table CLUB_EVENT_SESSION
--------------------------------------------------------

  CREATE TABLE "YCC"."CLUB_EVENT_SESSION" 
   (	"ID" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"ACTIVE" NUMBER(*,0), 
	"TITLE" VARCHAR2(50 CHAR), 
	"DESCRIPTION" VARCHAR2(200 CHAR), 
	...
	"EVENT_ID" NUMBER(*,0), 
	"MULTIPLE_CHOICES" VARCHAR2(50 CHAR), 
	"ALLOCATION_METHOD" VARCHAR2(50 CHAR), 
	"SESSION_TYPE" VARCHAR2(50 CHAR)
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "DATA02" ;
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02" 
 LOB ("DOCUMENT_VALUE") STORE AS SECUREFILE (
  TABLESPACE "DATA02" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES 
  STORAGE(INITIAL 106496 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0
...
--------------------------------------------------------
  ...
  CREATE TABLE "YCC"."DOCUMENT_TYPES" 
   (	"DOCUMENT_TYPE_ID" NUMBER, 
	"DOCUMENT_TYPE_NAME" VARCHAR2(50 BYTE), 
	"DOCUMENT_TYPE_CATEGORY" VARCHAR2(20 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
--  DDL for Table FEESRECORDS_HIST
--------------------------------------------------------

  CREATE TABLE "YCC"."FEESRECORDS_HIST" 
   (	"MEMBER_ID" NUMBER, 
	"YEAR_F" NUMBER, 
	"PAID_DATE" DATE, 
	"PAID_MODE" VARCHAR2(4 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Table HELPERS_APP_PERMISSIONS
--------------------------------------------------------

  CREATE TABLE "YCC"."HELPERS_APP_PERMISSIONS" 
   (	"MEMBER_ID" NUMBER, 
	"PERMISSION" VARCHAR2(10 BYTE), 
	"NOTE" NVARCHAR2(200)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Table HELPER_TASKS
--------------------------------------------------------

  CREATE TABLE "YCC"."HELPER_TASKS" 
   (	"ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3000 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"CATEGORY_ID" NUMBER, 
	"TITLE" NVARCHAR2(50), 
	...
	"HELPER_MIN_COUNT" NUMBER, 
	"HELPER_MAX_COUNT" NUMBER, 
	...
	"MARKED_AS_DONE_COMMENT" NCLOB, 
	"VALIDATION_COMMENT" NCLOB
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
 ...
 LOB ("LONG_DESCRIPTION") STORE AS SECUREFILE (
  ...
  PCTINCREASE 0
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("MARKED_AS_DONE_COMMENT") STORE AS SECUREFILE (
  TABLESPACE "DATA02" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES 
  STORAGE(INITIAL 106496 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("VALIDATION_COMMENT") STORE AS SECUREFILE (
  TABLESPACE "DATA02" ENABLE STORAGE IN ROW CHUNK 8192
  NOCACHE LOGGING  NOCOMPRESS  KEEP_DUPLICATES 
  STORAGE(INITIAL 106496 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table HELPER_TASK_CATEGORIES
--------------------------------------------------------

  CREATE TABLE "YCC"."HELPER_TASK_CATEGORIES" 
   (	"ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 10 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"TITLE" NVARCHAR2(50), 
	"SHORT_DESCRIPTION" NVARCHAR2(200), 
	"LONG_DESCRIPTION" NCLOB
   ) SEGMENT CREATION IMMEDIATE 
 ...
 LOB ("LONG_DESCRIPTION") STORE AS SECUREFILE (
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table HELPER_TASK_HELPERS
--------------------------------------------------------

  CREATE TABLE "YCC"."HELPER_TASK_HELPERS" 
   (	"TASK_ID" NUMBER, 
	"MEMBER_ID" NUMBER, 
	"SIGNED_UP_AT" DATE
   ) SEGMENT CREATION IMMEDIATE 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Table HTE_WEB_LOGON
--------------------------------------------------------

  CREATE GLOBAL TEMPORARY TABLE "YCC"."HTE_WEB_LOGON" 
   (	"RN_" NUMBER(10,0), 
	"MEMBER_ID" NUMBER(19,0), 
	"E_MAIL" VARCHAR2(255 CHAR), 
	"FIRSTNAME" VARCHAR2(255 CHAR), 
	"LOGON_ID" VARCHAR2(255 CHAR), 
	"LOGON_PASS2" VARCHAR2(255 CHAR), 
	"MEMBERSHIP" VARCHAR2(255 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "YCC"."HT_WEB_LOGON" 
   (	"MEMBER_ID" NUMBER(19,0)
   ) ON COMMIT DELETE ROWS ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Table IMPORT_SUI_LICENSES
--------------------------------------------------------

  CREATE TABLE "YCC"."IMPORT_SUI_LICENSES" 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "DATA02" ;
   ...
   COMMENT ON COLUMN "YCC"."INFOLICENCES"."HAS_TEST" IS 'Added by EB 06.24';
  GRANT SELECT ON "YCC"."INFOLICENCES" TO "YCCREAD";
  GRANT SELECT ON "YCC"."INFOLICENCES" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Table INFOLICENCES_BACKUP
--------------------------------------------------------

  CREATE TABLE "YCC"."INFOLICENCES_BACKUP" 
   (	"INFOID" NUMBER, 
	"NCOURSE" VARCHAR2(2 BYTE), 
	"NLICENCE" VARCHAR2(2 BYTE), 
	"NKEY" VARCHAR2(2 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "YCC"."KEYSLOG" 
   (	"KEYSLOG_ID" NUMBER, 
	...
	"RETURNED" DATE, 
	"LOG_ID" NUMBER, 
	"AUTHENTICATED" NUMBER DEFAULT 0, 
	"CATEGORY" VARCHAR2(20 BYTE) DEFAULT 'user'
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
--  DDL for Table LICENCES_HIST
--------------------------------------------------------

  CREATE TABLE "YCC"."LICENCES_HIST" 
   (	"MEMBER_ID" NUMBER, 
	"LICENCE_ID" NUMBER(2,0), 
	"LYEAR" NUMBER(4,0), 
	"LCOMMENTS" VARCHAR2(100 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "YCC"."MD_APPLICATIONFILES" 
   (	"ID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "DATA02" ;
   ...
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."NAME" IS 'file name  //OBJECTNAME';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."URI" IS 'The uri is the part of the file url after the base dir has been removed.  See MD_APPLICATION for base dir';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."TYPE" IS 'This will denote the type of file we have, including DIR, FILE (text), BINARY, IGNORE (where we choose to ignore files)';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."STATE" IS 'State will be how this file is operated on.  For example. it will be OPEN, NEW, FIXED, IGNORED, REVIEWED, COMPLETE';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."LANGUAGE" IS 'Language of the file that has been processed.';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."SECURITY_GROUP_ID" IS 'APEX';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."CREATED_ON" IS 'APEX';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."CREATED_BY" IS 'APEX';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."UPDATED_ON" IS 'APEX';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONFILES"."UPDATED_BY" IS 'APEX';
   COMMENT ON TABLE "YCC"."MD_APPLICATIONFILES"  IS 'Holds a tuple for each file that is being processed whether it is changed or not.';
--------------------------------------------------------
--  DDL for Table MD_APPLICATIONS
--------------------------------------------------------

  CREATE TABLE "YCC"."MD_APPLICATIONS" 
   (	"ID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "DATA02" ;
   ...
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONS"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONS"."NAME" IS 'Name of the application suite  //OBJECTNAME';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONS"."DESCRIPTION" IS 'Overview of what the application does.';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONS"."BASE_DIR" IS 'This is the base src directory for the application.  It could be an svn checkout, a clearcase view or something similar';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONS"."OUTPUT_DIR" IS 'This is the output directory where the scanner will present the converted files, if there are converted or modified.';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONS"."BACKUP_DIR" IS 'This is the directory in which the application files are backed up if a backp is chosen';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONS"."INPLACE" IS 'Designates whether the changes have been made inplace, in the source directory or not';
   COMMENT ON COLUMN "YCC"."MD_APPLICATIONS"."PROJECT_ID_FK" IS 'project of the database(s) this application relates to';
   COMMENT ON TABLE "YCC"."MD_APPLICATIONS"  IS 'This is the base table for application projects.  It holds the base information for applications associated with a database';
--------------------------------------------------------
--  DDL for Table MD_FILE_ARTIFACTS
--------------------------------------------------------

  CREATE TABLE "YCC"."MD_FILE_ARTIFACTS" 
   (	"ID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "DATA02" ;
   ...
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."PATTERN" IS 'Pattern used to search source file for interesting artifiacts';
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."STRING_FOUND" IS 'String found in source from the pattern supplied';
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."STRING_REPLACED" IS 'This is the string which replace the string found if it was replaced.';
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."TYPE" IS 'This is the type of the replacement.  It could be a straight replace from a replacement pattern, or we could have passed the string to a translator which would change the string depending on the database.';
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."STATUS" IS 'Pattern used to search source file for interesting artifiacts';
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."DUE_DATE" IS 'Due date is used by the TODO mechanism to manage the validation and work to complete this change';
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."DB_TYPE" IS 'Source database calls type';
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."CODE_TYPE" IS 'Source code db api, like dblib, jdbc';
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."DESCRIPTION" IS 'This is a description of the artifact which will have a default generated by the scanner and then can be modified by the user to be more appropriate for their use';
   COMMENT ON COLUMN "YCC"."MD_FILE_ARTIFACTS"."PRIORITY" IS 'The priority is set for the TODOs so they can be managed by the user';
   COMMENT ON TABLE "YCC"."MD_FILE_ARTIFACTS"  IS 'Holds a tuple for each interesting thing the scanner finds in a file';
--------------------------------------------------------
--  DDL for Table MD_TABLESPACES
--------------------------------------------------------

  CREATE TABLE "YCC"."MD_TABLESPACES" 
   (	"ID" NUMBER, 
	"SCHEMA_ID_FK" NUMBER, 
 ...
 LOB ("NATIVE_SQL") STORE AS BASICFILE (
  ...
  CACHE ) ;
   ...
   COMMENT ON COLUMN "YCC"."MD_TABLESPACES"."ID" IS 'Primary Key';
   COMMENT ON TABLE "YCC"."MD_TABLESPACES"  IS 'For storing information about tablespaces.';
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Table MEMBERSHIP_APPLICATIONS_HIST
--------------------------------------------------------

  CREATE TABLE "YCC"."MEMBERSHIP_APPLICATIONS_HIST" 
   (	"ID" NUMBER, 
	"NAME" VARCHAR2(25 BYTE), 
	"FIRSTNAME" VARCHAR2(25 BYTE), 
	"BIRTHDAY" DATE, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "MEMBERS_DATA_HISTORY" ("ID" NUMBER, "NAME" VARCHAR2(25 BYTE), "FIRSTNAME" VARCHAR2(25 BYTE), "BIRTHDAY" DATE, "NATIONALITY" VARCHAR2(3 BYTE), "MEMBERSHIP" VARCHAR2(2 BYTE), "TEMP_MEMB" NUMBER(1,0), "LANG1" VARCHAR2(3 BYTE), "LANG2" VARCHAR2(3 BYTE), "CATEGORY" VARCHAR2(1 BYTE), "WORK_ADDRESS1" VARCHAR2(50 BYTE), "WORK_ADDRESS2" VARCHAR2(50 BYTE), "WORK_TOWNCODE" VARCHAR2(7 BYTE), "WORK_TOWN" VARCHAR2(25 BYTE), "WORK_STATE" VARCHAR2(5 BYTE), "WORK_PHONE" VARCHAR2(25 BYTE), "E_MAIL" VARCHAR2(50 BYTE), "HOME_ADDR" VARCHAR2(50 BYTE), "HOME_TOWNCODE" VARCHAR2(7 BYTE), "HOME_TOWN" VARCHAR2(25 BYTE), "HOME_STATE" VARCHAR2(5 BYTE), "HOME_PHONE" VARCHAR2(25 BYTE), "MAIL_PREFERENCE" VARCHAR2(1 BYTE), "FAVOURITE_MAILING_POST" VARCHAR2(1 BYTE), "MEMBER_ENTRANCE" VARCHAR2(4 BYTE), "CELL_PHONE" VARCHAR2(25 BYTE), "GENDER" VARCHAR2(2 BYTE), "VALID_UNTIL_DATE" DATE, "VALID_FROM_DATE" DATE) ;
  GRANT SELECT ON "MEMBERS_DATA_HISTORY" TO "YCCAPEX";
  GRANT UPDATE ON "MEMBERS_DATA_HISTORY" TO "YCCAPEX";
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "MULTIPLERESERVATION" ("RES_ID" NUMBER, "MEMBER_ID" NUMBER, "RESDATE" DATE, "CREATED" DATE, "MODIFIED" DATE, "QUANTITY1" NUMBER(2,0), "QUANTITY2" NUMBER(2,0), "QUANTITY3" NUMBER(2,0), "QUANTITY4" NUMBER(2,0), "QUANTITY5" NUMBER(2,0) DEFAULT 0) ;
--------------------------------------------------------
--  DDL for Table NATIONALITIES_TO_DROP
--------------------------------------------------------

  CREATE TABLE "NATIONALITIES_TO_DROP" ("NATID" VARCHAR2(2 BYTE), "ENAME" VARCHAR2(15 BYTE), "FNAME" VARCHAR2(15 BYTE)) ;
  GRANT SELECT ON "NATIONALITIES_TO_DROP" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Table NEWMEMBERS_EMPTY
--------------------------------------------------------

  CREATE TABLE "NEWMEMBERS_EMPTY" ("ID" NUMBER, "NAME" VARCHAR2(25 BYTE), "FIRSTNAME" VARCHAR2(25 BYTE), "BIRTHDAY" DATE, "NATIONALITY" VARCHAR2(2 BYTE), "MEMBERSHIP" VARCHAR2(2 BYTE), "LANG" VARCHAR2(1 BYTE), "CATEGORY" VARCHAR2(1 BYTE), "ADDRESS1" VARCHAR2(50 BYTE), "ADDRESS2" VARCHAR2(50 BYTE), "TOWNCODE" NUMBER(7,0), "TOWN" VARCHAR2(25 BYTE), "STATE" VARCHAR2(2 BYTE), "PHONE1" VARCHAR2(15 BYTE), "PHONE2" VARCHAR2(15 BYTE), "CELLPHONE" VARCHAR2(15 BYTE), "E_MAIL" VARCHAR2(50 BYTE), "MAIL_PREFERENCE" VARCHAR2(1 BYTE), "MEMBER_ENTRANCE" NUMBER(4,0)) ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02" ;
  GRANT DELETE ON "REGATTAS_EXT" TO "YCCAPEX";
  GRANT INSERT ON "REGATTAS_EXT" TO "YCCAPEX";
  GRANT SELECT ON "REGATTAS_EXT" TO "YCCAPEX";
  GRANT UPDATE ON "REGATTAS_EXT" TO "YCCAPEX";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02" ;
  GRANT DELETE ON "REGATTAS_IN_SERIES" TO "YCCAPEX";
  GRANT INSERT ON "REGATTAS_IN_SERIES" TO "YCCAPEX";
  GRANT SELECT ON "REGATTAS_IN_SERIES" TO "YCCAPEX";
  GRANT UPDATE ON "REGATTAS_IN_SERIES" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Table REGATTA_PARTICIPATION
--------------------------------------------------------

  CREATE TABLE "REGATTA_PARTICIPATION" ("ID" NUMBER, "MEMBER_ID" NUMBER, "REGATTA_ID" NUMBER, "BOAT_ID" NUMBER, "PREFERENCE" VARCHAR2(15 BYTE), "COMMENTS" VARCHAR2(200 BYTE), "STATUS" VARCHAR2(15 BYTE) DEFAULT 'Submitted', "REPORT" VARCHAR2(4000 BYTE), "REPORT_PHOTO_LINK" VARCHAR2(200 BYTE), "REPORT_DATE" DATE, "ASSIGNED_BOAT_ID" NUMBER) ;
  GRANT DELETE ON "REGATTA_PARTICIPATION" TO "YCCAPEX";
  GRANT INSERT ON "REGATTA_PARTICIPATION" TO "YCCAPEX";
  GRANT SELECT ON "REGATTA_PARTICIPATION" TO "YCCAPEX";
  GRANT UPDATE ON "REGATTA_PARTICIPATION" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Table REGATTA_PROFILES
--------------------------------------------------------

  CREATE TABLE "REGATTA_PROFILES" ("ID" NUMBER, "MEMBER_ID" NUMBER, "PROFILE_YEAR" NUMBER(4,0), "LICENCE" VARCHAR2(10 BYTE), "CLUB" VARCHAR2(25 BYTE), "EXPERIENCE" VARCHAR2(1000 BYTE)) ;
  GRANT DELETE ON "REGATTA_PROFILES" TO "YCCAPEX";
  GRANT INSERT ON "REGATTA_PROFILES" TO "YCCAPEX";
  GRANT SELECT ON "REGATTA_PROFILES" TO "YCCAPEX";
  GRANT UPDATE ON "REGATTA_PROFILES" TO "YCCAPEX";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02" ;
  GRANT INSERT ON "REGATTA_SERIES_EXT" TO "YCCAPEX";
  GRANT DELETE ON "REGATTA_SERIES_EXT" TO "YCCAPEX";
  GRANT SELECT ON "REGATTA_SERIES_EXT" TO "YCCAPEX";
  GRANT UPDATE ON "REGATTA_SERIES_EXT" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Table RENEW_TOKENS
--------------------------------------------------------

  CREATE TABLE "YCC"."RENEW_TOKENS" 
   (	"ID" NUMBER(*,0), 
	"USER_ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESERVATIONS" ("RES_ID" NUMBER, "BOAT_ID" NUMBER(3,0), "OWNER_ID" NUMBER, "LABEL" VARCHAR2(25 BYTE), "DAY" DATE, "PERIOD" NUMBER(1,0), "LOCKED" NUMBER(1,0), "DELETED" DATE, "MODIFIED" DATE, "CATEGORY" VARCHAR2(20 BYTE)) ;
--------------------------------------------------------
--  DDL for Table RESERVATIONS_HIST
--------------------------------------------------------

  CREATE TABLE "YCC"."RESERVATIONS_HIST" 
   (	"RES_ID" NUMBER, 
	"BOAT_ID" NUMBER(3,0), 
	"OWNER_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "SYS_TEMP_FBT" ("SCHEMA" VARCHAR2(32 BYTE), "OBJECT_NAME" VARCHAR2(32 BYTE), "OBJECT#" NUMBER, "RID" UROWID (4000), "ACTION" CHAR(1 BYTE)) ON COMMIT PRESERVE ROWS ;
--------------------------------------------------------
--  DDL for Table TEACHERS
--------------------------------------------------------

  CREATE TABLE "TEACHERS" ("MEMBER_ID" NUMBER, "LICENSE" VARCHAR2(5 BYTE), "ACTIVE" NUMBER(1,0), "SINCE" NUMBER(4,0), "TEACHER_ID" NUMBER) ;
  GRANT SELECT ON "TEACHERS" TO "YCCREAD";
  GRANT DELETE ON "TEACHERS" TO "YCCAPEX";
  GRANT INSERT ON "TEACHERS" TO "YCCAPEX";
  GRANT SELECT ON "TEACHERS" TO "YCCAPEX";
  GRANT UPDATE ON "TEACHERS" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Table TEMPMEMBERS_LASTEMTRY2005_OBS
--------------------------------------------------------

  CREATE TABLE "TEMPMEMBERS_LASTEMTRY2005_OBS" ("MEMBER_ID" NUMBER, "PERIOD_YEAR" NUMBER(4,0), "PERIOD_FROM" VARCHAR2(3 BYTE), "PERIOD_TO" VARCHAR2(3 BYTE), "MONTHS" NUMBER(1,0), "COMMENTS" VARCHAR2(50 BYTE)) ;
--------------------------------------------------------
--  DDL for Table TEMP_LICENSES
--------------------------------------------------------

  CREATE TABLE "TEMP_LICENSES" ("LICENSE" NUMBER, "FIRST_NAME" VARCHAR2(200 BYTE), "LAST_NAME" VARCHAR2(200 BYTE)) ;
--------------------------------------------------------
--  DDL for Table TEMP_MEMBERS_LASTENTRY2001_OBS
--------------------------------------------------------

  CREATE TABLE "TEMP_MEMBERS_LASTENTRY2001_OBS" ("ID" NUMBER, "DATA" DATE, "NAME" VARCHAR2(50 BYTE), "MEMBERSHIP" VARCHAR2(10 BYTE), "PAID_IN" VARCHAR2(4 BYTE), "FEE" NUMBER, "COURSE" VARCHAR2(2 BYTE), "COURSE_COST" NUMBER, "TOTAL" NUMBER) ;
--------------------------------------------------------
--  DDL for Table TESTS
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "T_MEMBERS_OBSOLETE" ("T_ID" NUMBER, "T_YEAR" NUMBER(4,0), "T_FROM" DATE, "T_TO" DATE) ;
--------------------------------------------------------
--  DDL for Table USERLIST
--------------------------------------------------------

  CREATE TABLE "USERLIST" ("USERNAME" VARCHAR2(8 BYTE), "PASSWORD" VARCHAR2(10 BYTE)) ;
--------------------------------------------------------
--  DDL for Table WEBNEWS_EMPTY
--------------------------------------------------------

  CREATE TABLE "WEBNEWS_EMPTY" ("SUBMITTER" NUMBER, "SUBMITTER_EMAIL" VARCHAR2(50 BYTE), "SUBMISSION" DATE, "EXPIRY_DATE" DATE, "MESSAGE_TYPE" VARCHAR2(10 BYTE), "MESSAGE" VARCHAR2(500 BYTE), "MESSAGE_URL" VARCHAR2(100 BYTE), "IMAGE_URL" VARCHAR2(100 BYTE)) ;
--------------------------------------------------------
--  DDL for Table WEB_LOGON
--------------------------------------------------------

  CREATE TABLE "WEB_LOGON" ("MEMBER_ID" NUMBER, "LOGON_ID" VARCHAR2(25 BYTE), "SESSION_ID" NUMBER, "SESSION_DATE" DATE, "LOGON_PASS2" VARCHAR2(256 BYTE), "PASS_RESET_KEY" VARCHAR2(128 BYTE), "PASS_RESET_EXP" DATE, "LAST_CHANGED" DATE, "RF_UID" VARCHAR2(10 BYTE)) ;
  GRANT SELECT ON "WEB_LOGON" TO "YCCAPEX";
  GRANT UPDATE ON "WEB_LOGON" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Table WEB_LOGON_AUDIT
--------------------------------------------------------

  CREATE TABLE "WEB_LOGON_AUDIT" ("LOGON_ID" VARCHAR2(50 BYTE), "SESSION_ID" VARCHAR2(50 BYTE), "CLIENT_IP" VARCHAR2(50 BYTE), "EVENT_DATETIME" DATE, "EVENT_TYPE" VARCHAR2(30 BYTE), "RESPONSE" VARCHAR2(4000 BYTE)) ;
  GRANT INSERT ON "WEB_LOGON_AUDIT" TO "YCCAPEX";
  GRANT SELECT ON "WEB_LOGON_AUDIT" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Table YCCLOG
--------------------------------------------------------

  CREATE TABLE "YCCLOG" ("BOAT_ID" NUMBER(3,0), "OWNER_ID" NUMBER, "STATUS" VARCHAR2(10 BYTE), "MODIFIED" DATE, "KEYSLOG_ID" NUMBER, "LOG_ID" NUMBER, "LOG_COMMENT" CLOB, "SKIPPER" VARCHAR2(50 BYTE), "CREW" VARCHAR2(200 BYTE), "WIND" VARCHAR2(200 BYTE), "CREATED" DATE) ;
--------------------------------------------------------
--  DDL for View ACTIVE_MEMBERS_LICENCE_LIST
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ACTIVE_MEMBERS_LICENCE_LIST" ("ID", "NAME", "FIRSTNAME", "LICENCE_ID") AS SELECT 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BA5_EG" ("PREFIX", "K_NAME", "ID", "KEYID", "NAME", "FIRSTNAME", "ASSIGNED_DATE", "RETURN_DATE", "LAST_VERIF", "COMMENTS") AS SELECT 
    BA5.PREFIX, 
    BA5.NAME K_name, 
    MEMBERS.ID, 
    BA5ASSIGN.KEYID,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BOATS_ON_KEYS_DISTRIBUTOR" ("BOAT_ID", "NAME", "TYPE", "LICENSE", "CLASS", "TABLE_POS", "KEY_NR", "VIRTUAL") AS SELECT B.BOAT_ID, B.NAME, B.TYPE, B.LICENSE, B.CLASS, B.TABLE_POS, K.KEY_NR, K.VIRTUAL
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BOATS_VIEW" ("BOAT_ID", "NAME", "TYPE", "LICENSE", "CLASS", "TABLE_POS", "KEY_NR") AS SELECT B.BOAT_ID, B.NAME, B.TYPE, B.LICENSE, B.CLASS, B.TABLE_POS, K.KEY_NR 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BOAT_LOGS" ("BOAT_NAME", "LOG_DATE", "AUTHOR", "STATUS", "SKIPPER", "CREW", "WIND", "LOG") AS SELECT B.NAME AS BOAT_NAME, Y.MODIFIED AS LOG_DATE, 
       M.FIRSTNAME || ' ' || M.NAME AS AUTHOR, Y.STATUS AS STATUS,
       Y.SKIPPER, Y.CREW, Y.WIND, Y.LOG_COMMENT AS LOG
       FROM YCCLOG Y, MEMBERS M, BOATS B 
       WHERE M.ID=Y.OWNER_ID AND B.BOAT_ID=Y.BOAT_ID
;
--------------------------------------------------------
--  DDL for View BOAT_LOGS2
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."BOAT_LOGS2" ("LOG_ID", "TIME", "ID", "BOAT", "STATUS", "SKIPPER", "CREW", "WIND", "LOG_COMMENT") AS 
  select YCCLOG.LOG_ID, to_char(YCCLOG.MODIFIED, 'YYYY-MM-DD HH:MI:SS') as time, 
    WEB_LOGON.LOGON_ID as ID, BOATS.NAME as BOAT, YCCLOG.STATUS, 
    YCCLOG.SKIPPER, YCCLOG.CREW, YCCLOG.WIND, YCCLOG.LOG_COMMENT
    from YCCLOG
    join WEB_LOGON on WEB_LOGON.MEMBER_ID=YCCLOG.OWNER_ID
    join BOATS on BOATS.BOAT_ID=YCCLOG.BOAT_ID
    order by MODIFIED
;
--------------------------------------------------------
--  DDL for View BOAT_LOGS_WITH_NON_STANDARD_CHARS
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."BOAT_LOGS_WITH_NON_STANDARD_CHARS" ("LOG_ID", "MODIFIED", "LOG_COMMENT", "SKIPPER", "CREW", "WIND") AS 
  SELECT LOG_ID, MODIFIED, LOG_COMMENT, SKIPPER, CREW, WIND FROM YCCLOG WHERE
    LOG_ID > 37000 and (
        REGEXP_LIKE(LOG_COMMENT, '[^][+=@#$&*%''"\^~|.,:;!?/(){}<>_A-Za-z0-9 -].') OR 
        REGEXP_LIKE(SKIPPER, '[^][+=@#$&*%''"\^~|.,:;!?/(){}<>_A-Za-z0-9 -].') OR
        REGEXP_LIKE(CREW, '[^][+=@#$&*%''"\^~|.,:;!?/(){}<>_A-Za-z0-9 -].') OR
        REGEXP_LIKE(WIND, '[^][+=@#$&*%''"\^~|.,:;!?/(){}<>_A-Za-z0-9 -].') 
    )
    ORDER BY LOG_ID DESC
;
--------------------------------------------------------
--  DDL for View CURRENT_ACTIVE_MEMBERS_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."CURRENT_ACTIVE_MEMBERS_V" ("FAMILY_NAME", "FIRST_NAME", "BIRTH_DATE", "STREET", "POSTAL_CODE", "CITY", "COUNTRY", "E_DESC") AS 
  select distinct m.name family_name, m.firstname first_name, m.birthday birth_date, m.home_addr street, m.home_towncode postal_code, m.home_town city, m.home_state country, mm.e_desc  from members m
join feesrecords f on m.id = f.member_id 
join membership mm on mm.mb_name = m.membership
where year_f = to_char(sysdate, 'YYYY')
union 
select distinct m.name family_name, m.firstname first_name, m.birthday birth_date, m.home_addr street, m.home_towncode postal_code, m.home_town city, m.home_state country, mm.e_desc  from members m
join membership mm on mm.mb_name = m.membership and m.membership = 'H'
order by 1
;
--------------------------------------------------------
...
;
  GRANT SELECT ON "CURRENT_COMMITTEE" TO "YCCAPEX";
  GRANT SELECT ON "CURRENT_COMMITTEE" TO "YCCREAD";
--------------------------------------------------------
--  DDL for View CURRENT_DINGHY_COURSE_ALL
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CURRENT_DINGHY_COURSE_ALL" ("MEMBER_ID", "FIRSTNAME", "NAME", "E_MAIL") AS select lr.member_id, FIRSTNAME, name, E_MAIL
...
;
  GRANT SELECT ON "CURRENT_DINGHY_COURSE_ALL" TO "YCCREAD";
--------------------------------------------------------
--  DDL for View FAVOURITE_MAIL_PAPER_EG
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "FAVOURITE_MAIL_PAPER_EG" ("NAME", "FIRSTNAME", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE") AS SELECT 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "FEESRECORDS_TOTALS" ("MEMBER_ID", "YEAR_F", "TOTAL_PAID") AS select member_id, year_f, sum(fee) total_paid
from feesrecords
group by member_id, year_f

;
  GRANT SELECT ON "FEESRECORDS_TOTALS" TO "YCCAPEX";
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "GLOBAL_WEB_LOGON" ("MEMBER_ID", "LOGON_ID", "LOGON_PASSWD", "FIRSTNAME", "NAME", "E_MAIL", "ACCESS_TYPE") AS select member_id, logon_id, logon_passwd, firstname,name,e_mail, 'YCC MEMBER' access_type from web_logon wl inner join ycc.members m on m.id = wl.member_id
union
select id, logon_id, logon_passwd, firstname, name, e_mail, 'PREREGISTERED USER' from membership_applications
;
  GRANT SELECT ON "GLOBAL_WEB_LOGON" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View HELPERS_RESERVATIONS_2023_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "HELPERS_RESERVATIONS_2023_V" ("ID", "FIRSTNAME", "NAME", "RESERVATION_NO", "SPECIAL_RESERVATION_NO", "HELP_NO") AS with number_helps_v as (
select member_id, count(*) number_helps from (
    select member_id from helper_task_helpers hth
    join helper_tasks ht on ht.id = hth.task_id
    where coalesce(ht.deadline, ht.ends_at) > '01.01.23 00:00:00' and coalesce(ht.deadline, ht.ends_at) < '01.01.24 00:00:00' 
union all
    select ht.captain_id from helper_tasks ht 
    where coalesce(ht.deadline, ht.ends_at) > '01.01.23 00:00:00' and coalesce(ht.deadline, ht.ends_at) < '01.01.24 00:00:00' and ht.captain_id is not null)
group by member_id),
number_special_reservations_v as (
select abs(owner_id) special_owner_id, count(*) special_reservation_number from reservations 
where deleted is not null
and day > '01.01.23 00:00:00' and day < '01.01.24 00:00:00' 
and owner_id < 0
group by abs(owner_id)),
number_reservations_v as (
select abs(owner_id) owner_id, count(*) reservation_number from reservations 
where deleted is not null
and day > '01.01.23 00:00:00' and day < '01.01.24 00:00:00' 
and owner_id > 0
group by abs(owner_id))
select m.id, m.firstname, m.name, coalesce(nr.reservation_number,0) reservation_no, coalesce(nsr.special_reservation_number,0) special_reservation_no, coalesce(nh.number_helps,0) help_no from members m
left join number_helps_v nh on nh.member_id = m.id
left join number_reservations_v nr on nr.owner_id = m.id
left join number_special_reservations_v nsr on nsr.special_owner_id = m.id
where owner_id is not null or member_id is not null or special_owner_id is not null
order by coalesce(number_helps,0) desc, coalesce(reservation_number,0) desc, coalesce(special_reservation_number,0) desc
;
--------------------------------------------------------
--  DDL for View HELPERS_RESERVATIONS_2024_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "HELPERS_RESERVATIONS_2024_V" ("ID", "FIRSTNAME", "NAME", "RESERVATION_NO", "SPECIAL_RESERVATION_NO", "HELP_NO") AS with number_helps_v as (
select member_id, count(*) number_helps from (
    select member_id from helper_task_helpers hth
    join helper_tasks ht on ht.id = hth.task_id
    where coalesce(ht.deadline, ht.ends_at) > '01.01.24 00:00:00' and coalesce(ht.deadline, ht.ends_at) < '01.01.25 00:00:00' 
union all
    select ht.captain_id from helper_tasks ht 
    where coalesce(ht.deadline, ht.ends_at) > '01.01.24 00:00:00' and coalesce(ht.deadline, ht.ends_at) < '01.01.25 00:00:00' and ht.captain_id is not null)
group by member_id),
number_special_reservations_v as (
select abs(owner_id) special_owner_id, count(*) special_reservation_number from reservations 
where deleted is not null
and day > '01.01.24 00:00:00' and day < '01.01.25 00:00:00' 
and owner_id < 0
group by abs(owner_id)),
number_reservations_v as (
select abs(owner_id) owner_id, count(*) reservation_number from reservations 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "KEY_LOGS_VIEW" ("NAME", "FIRSTNAME", "BNAME", "TAKEN", "RETURNED") AS SELECT M.NAME AS NAME, M.FIRSTNAME, B.NAME AS BNAME,
...
ORDER by K.TAKEN DESC
;
--------------------------------------------------------
--  DDL for View LATEST_REGATTA_PROFILES
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LATEST_REGATTA_PROFILES" ("ID", "MEMBER_ID", "PROFILE_YEAR", "LICENCE", "CLUB", "EXPERIENCE") AS select "ID","MEMBER_ID","PROFILE_YEAR","LICENCE","CLUB","EXPERIENCE" from ycc.regatta_profiles
where id in (
...
;
  GRANT SELECT ON "LATEST_REGATTA_PROFILES" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View LEVEL0LOTTERY
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LEVEL0LOTTERY" ("NAME", "FIRSTNAME", "LEVEL0") AS SELECT 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LICENCES_BOAT" ("ID", "NAME", "FIRSTNAME", "LICENCE_ID") AS SELECT 
    id, name, firstname, licence_id
FROM
 members, licences, feesrecords
WHERE
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LICENCES_VIEW" ("ID", "NAME", "FIRSTNAME", "LICENCE_ID", "NLICENCE", "LYEAR", "LCOMMENTS") AS SELECT MEMBERS.ID, MEMBERS.NAME, MEMBERS.FIRSTNAME, LICENCES.LICENCE_ID, INFOLICENCES.NLICENCE, LICENCES.LYEAR, LICENCES.LCOMMENTS
...
;
  GRANT SELECT ON "LOTTERY_APPLICATIONS" TO "YCCREAD";
  GRANT SELECT ON "LOTTERY_APPLICATIONS" TO "YCCAPEX";
--------------------------------------------------------
...
where lp.key=r.key and
      r.member_id=a.id
;
  GRANT SELECT ON "LOTTERY_RANKING" TO "YCCREAD";
  GRANT SELECT ON "LOTTERY_RANKING" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View MAINTAINERS
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MAINTAINERS" ("ID", "PRIORITY", "BOAT_ID", "TABLE_POS", "B_NAME", "B_TYPE", "B_LICENCE", "B_CLASS", "M_ID", "M_NAME", "M_FIRSTNAME", "M_EMAIL") AS SELECT 
    BOAT_MAINTAINER.ID ID, BOAT_MAINTAINER.PRIORITY PRIORITY, 
    BOATS.BOAT_ID BOAT_ID, BOATS.TABLE_POS TABLE_POS, BOATS.NAME B_NAME, 
    BOATS.TYPE B_TYPE, BOATS.LICENSE B_LICENCE, BOATS.CLASS B_CLASS, 
    MEMBERS.ID M_ID, MEMBERS.NAME M_NAME, MEMBERS.FIRSTNAME M_FIRSTNAME, 
    MEMBERS.E_MAIL M_EMAIL FROM BOATS
    INNER JOIN BOAT_MAINTAINER on BOAT_MAINTAINER.BOAT_ID = BOATS.BOAT_ID 
    INNER JOIN MEMBERS ON BOAT_MAINTAINER.MEMBER_ID = MEMBERS.ID
ORDER BY BOATS.TABLE_POS, BOAT_MAINTAINER.PRIORITY
;
--------------------------------------------------------
--  DDL for View MARINE_ACTIVE_MEMBERS_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."MARINE_ACTIVE_MEMBERS_V" ("FAMILY_NAME", "FIRST_NAME", "CATEGORY", "BIRTH_DATE", "STREET", "POSTAL_CODE", "CITY", "COUNTRY", "E_DESC", "MEMBER_ENTRANCE") AS 
  select "FAMILY_NAME","FIRST_NAME","CATEGORY", "BIRTH_DATE","STREET","POSTAL_CODE","CITY","COUNTRY","E_DESC","MEMBER_ENTRANCE" from (  select distinct m.name family_name, m.firstname first_name, m.category category, m.birthday birth_date, 
  m.home_addr street, m.home_towncode postal_code, m.home_town city, m.home_state country, mm.e_desc,
  m.member_entrance
  from members m
join feesrecords f on m.id = f.member_id 
join membership mm on mm.mb_name = m.membership
where year_f = 2024
union 
select distinct m.name family_name, m.firstname first_name, m.category category,m.birthday birth_date, m.home_addr street, 
m.home_towncode postal_code, m.home_town city, m.home_state country, mm.e_desc,   m.member_entrance  from members m
join membership mm on mm.mb_name = m.membership and m.membership = 'H'
order by 1)
;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERLABELS2003JUL31" ("ID", "LANG1", "NAME", "FIRSTNAME", "A1", "A2", "AC", "AT", "WORK_STATE") AS select
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERSPAPERADDRESS" ("ID", "NAME", "FIRSTNAME", "MEMBERSHIP", "CATEGORY", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE") AS select DISTINCT id, name, firstname, membership,category, home_addr,home_towncode,home_town,home_state
  from members, feesrecords
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERSPASSWDVIEW" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP", "LOGON_ID") AS select ID,NAME,FIRSTNAME,
E_MAIL,
MEMBERSHIP,
LOGON_ID
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_CURRENT" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP") AS SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M inner join old_member_payments omp on M.ID=omp.MEMBER_ID
...
SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M 
   where M.MEMBERSHIP='H' or M.MEMBERSHIP='SV'
union
-- Maintanance contractors
SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M
   where m.id = 3333 --Top Sails
;
  GRANT SELECT ON "MEMBERS_CURRENT" TO "YCCREAD";
  GRANT SELECT ON "MEMBERS_CURRENT" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View MEMBERS_CURRENT_BEFORE_2010
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_CURRENT_BEFORE_2010" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP") AS SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M inner join FEESRECORDS F on M.ID=F.MEMBER_ID
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_CURRENT_WITHNAT" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP", "NATIONALITY", "ENAME") AS SELECT 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_CURRENT_WITH_CATEGORY" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP", "CATEGORY") AS SELECT DISTINCT m.ID,
    NAME,
    FIRSTNAME,
    E_MAIL,
    MEMBERSHIP, category
...
SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M
   where m.id = 3333 --Quantum Sails
;
  GRANT SELECT ON "MEMBERS_PREVIOUS_YEAR" TO "YCCREAD";
--------------------------------------------------------
--  DDL for View MEMBERS_RIGHTS
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_RIGHTS" ("ID", "NAME", "FIRSTNAME", "RES", "Key", "MEM", "LIC", "RIG", "MODIFIED", "COMMENTS") AS select m.ID, m.NAME, m.FIRSTNAME,
...
;
--------------------------------------------------------
--  DDL for View MEMBERS_WITH_NON_STANDARD_NAMES
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_WITH_NON_STANDARD_NAMES" ("ID", "NAME", "FIRSTNAME") AS SELECT 
    ID, NAME, FIRSTNAME FROM MEMBERS 
WHERE REGEXP_LIKE(NAME, '[^''.A-Za-z \-].') OR 
    REGEXP_LIKE(FIRSTNAME, '[^''.A-Za-z \-].') ORDER BY ID
;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MY_CURRENT_MEMBERS" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP") AS SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M inner join old_member_payments omp on M.ID=omp.MEMBER_ID
...
;
  GRANT SELECT ON "M_AND_A" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View M_KEY
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "NEW_MEMBER_PAYMENTS" ("MEMBER_ID", "LOGON_ID", "MEMBERSHIP_TYPE", "ENTRANCE_FEE", "ANNUAL_FEE", "KEY", "COURSEFEE", "COURSE_NAME", "PRINT_RECEIVED") AS select
ma.id member_id,
ma.logon_id,
...
;
  GRANT SELECT ON "NEW_MEMBER_PAYMENTS" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View NO_MORE_JUNIORS
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "NO_MORE_JUNIORS" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY") AS SELECT id, name, firstname, birthday
	...
	select
		...
		case
			when
				...
				and not (nvl(m1.birthday,sysdate-numtoyminterval(28,'year'))+numtoyminterval(26,'year') > to_date('01/04/'||to_char(ycc.get_current_membership_year),'DD/MM/YYYY'))
			then 'AS'
			else
...
;
  GRANT SELECT ON "OLD_MEMBER_PAYMENTS" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View OLD_SWS_TO_BE_SENT
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "OLD_SWS_TO_BE_SENT" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "LANG1") AS SELECT DISTINCT 
    MEMBERS.ID, 
    MEMBERS.NAME, 
    MEMBERS.FIRSTNAME, 
    MEMBERS.BIRTHDAY, 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PAIMENT_INVOICES" ("ID", "NAME", "FIRSTNAME", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "CATEGORY", "MEMBERSHIP", "BIRTHDAY") AS SELECT DISTINCT(id), name, firstname, home_addr, home_towncode, home_town, home_state, category, membership, birthday
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "REGATTA_PROFILES_RECENT" ("ID", "MEMBER_ID", "PROFILE_YEAR", "LICENCE", "CLUB", "EXPERIENCE") AS select "ID","MEMBER_ID","PROFILE_YEAR","LICENCE","CLUB","EXPERIENCE" from regatta_profiles
where id in (select max(id) from regatta_profiles group by member_id)

;
  GRANT SELECT ON "REGATTA_PROFILES_RECENT" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View RES_VIEW
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "RES_VIEW" ("RES_ID", "OWNER", "BOAT", "LABEL", "DAY", "PERIOD", "DELETED", "MODIFIED") AS SELECT R.RES_ID, M.NAME AS OWNER, B.NAME AS BOAT, R.LABEL, TO_CHAR(R.DAY, 'DD MON YY') AS DAY, R.PERIOD,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "STATISTICS_MEMBERS" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP", "NATIONALITY", "MEMBER_ENTRANCE", "CATEGORY") AS SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP, NATIONALITY, MEMBER_ENTRANCE, CATEGORY   FROM MEMBERS M inner join old_member_payments omp on M.ID=omp.MEMBER_ID
  where (get_current_calendar_year = get_current_membership_year) and (total_paid_curr_m_y >= nvl(entrance_fee,0)+nvl(annual_fee,0)) and (nvl(membership,'X') <> 'T' or trunc(sysdate) <= trunc(valid_until_date))
union
-- after General Assembly previous year
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TESTS_VIEW" ("TEST_DATE", "FIRSTNAME", "NAME", "TESTER_F", "TESTER_N", "TEST_TYPE", "RESULT", "COMMENTS") AS SELECT TEST_DATE, M.FIRSTNAME, M.NAME, T.FIRSTNAME as TESTER_F, T.NAME as TESTER_N, TEST_TYPE, RESULT, COMMENTS from TESTS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "V1" ("ID", "LANG1", "NAME", "FIRSTNAME", "A1", "A2", "AC", "AT", "ASTATE") AS select
 distinct id,lang1,name,firstname,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW1" ("NAME", "FIRSTNAME", "ID", "E_MAIL", "WORK_PHONE", "CELL_PHONE", "HOME_PHONE") AS select m.name, m.firstname, m.id, m.e_mail, m.work_phone, m.cell_phone, m.home_phone
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW2" ("MEMBER_ID", "PAID_DATE", "YEAR_F", "ENTERED_DATE", "FEE") AS SELECT 
    MEMBER_ID, 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW5" ("ID", "NAME", "FIRSTNAME") AS SELECT DISTINCT m.ID, NAME, FIRSTNAME FROM MEMBERS M inner join old_member_payments omp on M.ID=omp.MEMBER_ID
  where (get_current_calendar_year = get_current_membership_year) and (total_paid_curr_m_y >= nvl(entrance_fee,0)+nvl(annual_fee,0)) and (nvl(membership,'X') <> 'T' or trunc(sysdate) <= trunc(valid_until_date))
union
-- after General Assembly previous year
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW6" ("ID", "NAME", "FIRSTNAME") AS SELECT DISTINCT 
    MEMBERS.ID, 
    MEMBERS.NAME, 
    MEMBERS.FIRSTNAME
FROM 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BOAT_KEYS_PK" ON "BOAT_KEYS" ("KEY_NR") ;
--------------------------------------------------------
--  DDL for Index BOAT_KEYS_UK1
--------------------------------------------------------

  CREATE UNIQUE INDEX "BOAT_KEYS_UK1" ON "BOAT_KEYS" ("BOAT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."DB_EDITS_PK" ON "YCC"."DB_EDITS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."DOCUMENTS_PK" ON "YCC"."DOCUMENTS" ("DOCUMENT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "DOCUMENT_TYPES_PK" ON "DOCUMENT_TYPES" ("DOCUMENT_TYPE_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Index PK_YCCLOG
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_YCCLOG" ON "YCCLOG" ("LOG_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Index RESERVATIONS_HIST_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "YCC"."RESERVATIONS_HIST_PK" ON "YCC"."RESERVATIONS_HIST" ("RES_ID", "CREATE_TIME_UTC") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."STATUS_PK" ON "YCC"."STATUS" ("STAT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Index feesrecords_HIST_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "feesrecords_HIST_PK" ON "FEESRECORDS_HIST" ("PAYMENTID", "CREATE_TIME_UTC") ;
--------------------------------------------------------
--  DDL for Index HELPERS_APP_PERMISSIONS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "HELPERS_APP_PERMISSIONS_PK" ON "HELPERS_APP_PERMISSIONS" ("MEMBER_ID") ;
--------------------------------------------------------
--  DDL for Index HELPER_TASKS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "HELPER_TASKS_PK" ON "HELPER_TASKS" ("ID") ;
--------------------------------------------------------
--  DDL for Index HELPER_TASK_CATEGORIES_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "YCC"."HELPER_TASK_CATEGORIES_PK" ON "YCC"."HELPER_TASK_CATEGORIES" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Index HELPER_TASK_HELPERS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "YCC"."HELPER_TASK_HELPERS_PK" ON "YCC"."HELPER_TASK_HELPERS" ("TASK_ID", "MEMBER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."INFOLICENCES_UK1" ON "YCC"."INFOLICENCES" ("NLICENCE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."MD_APPLICATIONS_PK" ON "YCC"."MD_APPLICATIONS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02" ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Index MEMBERSHIP_APPLICATIONS_HIST_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "YCC"."MEMBERSHIP_APPLICATIONS_HIST_PK" ON "YCC"."MEMBERSHIP_APPLICATIONS_HIST" ("ID", "CREATE_TIME_UTC") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  DDL for Index YCCLOG_INDEX1
--------------------------------------------------------

  CREATE INDEX "YCCLOG_INDEX1" ON "YCCLOG" ("CREATED" DESC) ;
--------------------------------------------------------
--  DDL for Index MD_APP_FILE_TYPE_IDX
--------------------------------------------------------

  CREATE INDEX "YCC"."MD_APP_FILE_TYPE_IDX" ON "YCC"."MD_APPLICATIONFILES" ("TYPE", "ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02" ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Index DOCUMENT_TYPES_DOCUMENT_TYPE_NAME_UK
--------------------------------------------------------

  CREATE UNIQUE INDEX "DOCUMENT_TYPES_DOCUMENT_TYPE_NAME_UK" ON "DOCUMENT_TYPES" (UPPER("DOCUMENT_TYPE_NAME")) ;
--------------------------------------------------------
--  DDL for Trigger FEESRECORDS_EDITED
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "FEESRECORDS_EDITED" 
AFTER DELETE OR INSERT OR UPDATE ON ycc.FEESRECORDS 
FOR EACH ROW
DECLARE
    D DATE;
    R_ID NUMBER;
...
--------------------------------------------------------
--  DDL for Trigger FEESRECORDS_HIST
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."FEESRECORDS_HIST" for insert or update or delete on feesrecords
compound trigger

l_non_key_data clob;
l_stmt_op_type varchar2(1);
l_op_type_1 feesrecords_hist.op_type%type;
l_op_type_2 feesrecords_hist.op_type%type;
l_rid_1 rowid;
l_rid_2 rowid;
...
begin
	begin 
	 case
		when inserting  then l_stmt_op_type :=  'I';
		when updating   then l_stmt_op_type :=  'U';
		when deleting   then l_stmt_op_type :=  'D';
		else raise_application_error(-20001, 'A merge error provoked this trigger exception ex "ORA-30926: unable to get a stable set of rows in the source tables", disable history trigger and repeat DML to verify. Fix the root cause');
	end case;
	end;
...
begin
	...
	case
	 when inserting then 
		select max(distinct (case when rownum = 1 then op_type else null end)) op_type_1
		...
		if l_op_type_1 = 'D' then
			select MEMBER_ID||YEAR_F||PAID_DATE||PAID_MODE||FEE||ENTERED_DATE||payment_reason
			into l_non_key_data
			from feesrecords_hist
			where rowid = l_rid_1;

			if l_non_key_data = to_char(:new.MEMBER_ID||:new.YEAR_F||:new.PAID_DATE||:new.PAID_MODE||:new.FEE||:new.ENTERED_DATE||:new.payment_reason) then
				delete from feesrecords_hist where rowid = l_rid_1;
			else
				insert into feesrecords_hist (PAYMENTID, MEMBER_ID, YEAR_F, PAID_DATE, PAID_MODE, FEE, ENTERED_DATE, payment_reason, op_type, create_time_utc, transaction_id, module, action, client_info)
				values (:new.PAYMENTID, :new.MEMBER_ID, :new.YEAR_F, :new.PAID_DATE, :new.PAID_MODE, :new.FEE, :new.ENTERED_DATE, :new.payment_reason, 'I', sysdate, dbms_transaction.local_transaction_id, sys_context('userenv', 'module'), sys_context('userenv', 'action'), coalesce(sys_context('userenv', 'client_info'), sys_context('USERENV', 'OS_USER')||'@'||sys_context('USERENV', 'HOST')||' via '||sys_context('USERENV', 'SESSION_USER')));
			end if;
	 ...
	 when updating then 
			if 
				...
				(:old.PAYMENTID is null and :new.PAYMENTID is not null) or
				(:old.PAYMENTID is not null and :new.PAYMENTID is null) or
				(:old.MEMBER_ID != :new.MEMBER_ID) or
				(:old.MEMBER_ID is null and :new.MEMBER_ID is not null) or
				(:old.MEMBER_ID is not null and :new.MEMBER_ID is null) or
				(:old.YEAR_F != :new.YEAR_F) or
				(:old.YEAR_F is null and :new.YEAR_F is not null) or
				(:old.YEAR_F is not null and :new.YEAR_F is null) or
				(:old.PAID_DATE != :new.PAID_DATE) or
				(:old.PAID_DATE is null and :new.PAID_DATE is not null) or
				(:old.PAID_DATE is not null and :new.PAID_DATE is null) or
				(:old.PAID_MODE != :new.PAID_MODE) or
				(:old.PAID_MODE is null and :new.PAID_MODE is not null) or
				(:old.PAID_MODE is not null and :new.PAID_MODE is null) or
				(:old.FEE != :new.FEE) or
				(:old.FEE is null and :new.FEE is not null) or
				(:old.FEE is not null and :new.FEE is null) or
                (:old.payment_reason != :new.payment_reason) or
				(:old.payment_reason is null and :new.payment_reason is not null) or
				(:old.payment_reason is not null and :new.payment_reason is null) or
				(:old.ENTERED_DATE != :new.ENTERED_DATE) or
				(:old.ENTERED_DATE is null and :new.ENTERED_DATE is not null) or
				(:old.ENTERED_DATE is not null and :new.ENTERED_DATE is null) then

				insert into feesrecords_hist (PAYMENTID, MEMBER_ID, YEAR_F, PAID_DATE, PAID_MODE, FEE, ENTERED_DATE, payment_reason, op_type, create_time_utc, transaction_id, module, action, client_info)
				values (:new.PAYMENTID, :new.MEMBER_ID, :new.YEAR_F, :new.PAID_DATE, :new.PAID_MODE, :new.FEE, :new.ENTERED_DATE, :new.payment_reason, 'U', sysdate, dbms_transaction.local_transaction_id, sys_context('userenv', 'module'), sys_context('userenv', 'action'), coalesce(sys_context('userenv', 'client_info'), sys_context('USERENV', 'OS_USER')||'@'||sys_context('USERENV', 'HOST')||' via '||sys_context('USERENV', 'SESSION_USER')));
    ...
    coalesce(sys_context('userenv', 'client_info'), sys_context('USERENV', 'OS_USER')
                                                    || '@'
	...
	exception 
		when others then
            raise_application_error(-20001, 'Error in feesrecords_hist trigger. Err: ' || dbms_utility.format_error_stack);
	end;
end after each row;

end feesrecords_hist;
/
ALTER TRIGGER "YCC"."FEESRECORDS_HIST" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger HELPER_TASKS_CHECK_CANNOT_BE_CAPTAIN_IF_ALREADY_HELPER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."HELPER_TASKS_CHECK_CANNOT_BE_CAPTAIN_IF_ALREADY_HELPER" 
...
/
ALTER TRIGGER "YCC"."HELPER_TASKS_CHECK_CANNOT_BE_CAPTAIN_IF_ALREADY_HELPER" ENABLE;
--------------------------------------------------------
--  DDL for Trigger HELPER_TASKS_CHECK_MAX_HELPER_COUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."HELPER_TASKS_CHECK_MAX_HELPER_COUNT" 
...
/
ALTER TRIGGER "YCC"."HELPER_TASKS_CHECK_MAX_HELPER_COUNT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger HELPER_TASK_HELPERS_CHECK_CANNOT_BE_HELPER_IF_ALREADY_CAPTAIN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "HELPER_TASK_HELPERS_CHECK_CANNOT_BE_HELPER_IF_ALREADY_CAPTAIN" 
...
/
ALTER TRIGGER "HELPER_TASK_HELPERS_CHECK_CANNOT_BE_HELPER_IF_ALREADY_CAPTAIN" ENABLE;
--------------------------------------------------------
--  DDL for Trigger HELPER_TASK_HELPERS_CHECK_NO_MORE_HELPERS_THAN_MAX_HELPER_COUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "HELPER_TASK_HELPERS_CHECK_NO_MORE_HELPERS_THAN_MAX_HELPER_COUNT" 
...
/
ALTER TRIGGER "HELPER_TASK_HELPERS_CHECK_NO_MORE_HELPERS_THAN_MAX_HELPER_COUNT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger HELPER_TASK_HELPERS_FORBID_UPDATES
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."HELPER_TASK_HELPERS_FORBID_UPDATES" 
...
/
ALTER TRIGGER "YCC"."HELPER_TASK_HELPERS_FORBID_UPDATES" ENABLE;
--------------------------------------------------------
...
AFTER DELETE OR INSERT OR UPDATE ON ycc.LICENCES 
FOR EACH ROW
DECLARE
    D DATE;
    R_ID NUMBER;
...
--------------------------------------------------------
--  DDL for Trigger LICENCES_HIST
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."LICENCES_HIST" FOR
    INSERT OR UPDATE OR DELETE ON licences
COMPOUND TRIGGER
    l_non_key_data CLOB;
    l_stmt_op_type varchar2(1);
    l_op_type_1    licences_hist.op_type%TYPE;
    l_op_type_2    licences_hist.op_type%TYPE;
    l_rid_1        ROWID;
    l_rid_2        ROWID;
        ...
        BEGIN
            CASE
                ...
                WHEN deleting THEN
                    l_stmt_op_type := 'D';
                ELSE
                    raise_application_error(-20001, 'A merge error provoked this trigger exception ex "ORA-30926: unable to get a stable set of rows in the source tables", disable history trigger and repeat DML to verify. Fix the root cause');
            END CASE;
    ...
    AFTER EACH ROW IS BEGIN
            ...
            CASE
                WHEN inserting THEN
                    ...
                    IF l_op_type_1 = 'D' THEN
                        ...
                        IF l_non_key_data = to_char(:new.lyear
                                                    || :new.lcomments
                                                    || :new.test_id
                                                    || :new.status) THEN
                            DELETE FROM licences_hist
                            WHERE
                                ROWID = l_rid_1;

                        ELSE
                            INSERT INTO licences_hist (
                                member_id,
                                licence_id,
                                lyear,
                                lcomments,
                ...
                WHEN updating THEN
                    IF ( :old.member_id != :new.member_id ) OR (
                        :old.member_id IS NULL
                        AND :new.member_id IS NOT NULL
                    ) OR (
                        :old.member_id IS NOT NULL
                        AND :new.member_id IS NULL
                    ) OR ( :old.licence_id != :new.licence_id ) OR (
                        :old.licence_id IS NULL
                        AND :new.licence_id IS NOT NULL
                    ) OR (
                        :old.licence_id IS NOT NULL
                        AND :new.licence_id IS NULL
                    ) OR ( :old.lyear != :new.lyear ) OR (
                        :old.lyear IS NULL
                        AND :new.lyear IS NOT NULL
                    ) OR (
                        :old.lyear IS NOT NULL
                        AND :new.lyear IS NULL
                    ) OR ( :old.lcomments != :new.lcomments ) OR (
                        :old.lcomments IS NULL
                        AND :new.lcomments IS NOT NULL
                    ) OR (
                        :old.lcomments IS NOT NULL
                        AND :new.lcomments IS NULL
                    ) OR ( :old.test_id != :new.test_id ) OR (
                        :old.test_id IS NULL
                        AND :new.test_id IS NOT NULL
                    ) OR (
                        :old.test_id IS NOT NULL
                        AND :new.test_id IS NULL
                    ) OR ( :old.status != :new.status ) OR (
                        :old.status IS NULL
        ...
        EXCEPTION
            WHEN OTHERS THEN
                raise_application_error(-20001, 'Error in LICENCES_HIST trigger. Err: ' || dbms_utility.format_error_stack);
        END;
    END AFTER EACH ROW;
END licences_hist;

/
ALTER TRIGGER "YCC"."LICENCES_HIST" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MEMBERSHIP_APPLICATIONS_HIST
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "MEMBERSHIP_APPLICATIONS_HIST" for insert or update or delete on membership_applications
compound trigger

l_non_key_data clob;
l_stmt_op_type varchar2(1);
l_op_type_1 membership_applications_hist.op_type%type;
l_op_type_2 membership_applications_hist.op_type%type;
l_rid_1 rowid;
l_rid_2 rowid;
...
begin
	...
	case
	 when inserting then 
		...
		from (
			select rowid rid, op_type
			from membership_applications_hist
			where id=:new.id
			order by create_time_utc desc
		)
		where rownum <=2;
		...
		if l_op_type_1 = 'D' then
			select name||firstname||birthday||nationality||membership||temp_memb||lang1||lang2||category||work_address1||work_address2||work_towncode||work_town||work_state||work_phone||e_mail||home_addr||home_towncode||home_town||home_state||home_phone||mail_preference||favourite_mailing_post||member_entrance||cell_phone||logon_id||logon_passwd||course1||course2||print_received||submitted_date||last_updated_date||gender||logon_pass2||pass_reset_key||pass_reset_exp||last_changed||valid_until_date||valid_from_date||interest_in_fibreglass||interest_in_woodwork||interest_in_ropework||interest_in_paintwork||interest_in_organising_social||interest_in_organising_regattas||interest_in_teaching_dinghies||interest_in_teaching_cats||interest_in_teaching_keelboats||interest_in_teaching_motorboats||interest_in_surveillance||interest_in_towing_on_land||special_talents||interest_in_motors
			into l_non_key_data
			from membership_applications_hist
			where rowid = l_rid_1;

			if l_non_key_data = to_char(:new.name||:new.firstname||:new.birthday||:new.nationality||:new.membership||:new.temp_memb||:new.lang1||:new.lang2||:new.category||:new.work_address1||:new.work_address2||:new.work_towncode||:new.work_town||:new.work_state||:new.work_phone||:new.e_mail||:new.home_addr||:new.home_towncode||:new.home_town||:new.home_state||:new.home_phone||:new.mail_preference||:new.favourite_mailing_post||:new.member_entrance||:new.cell_phone||:new.logon_id||:new.logon_passwd||:new.course1||:new.course2||:new.print_received||:new.submitted_date||:new.last_updated_date||:new.gender||:new.logon_pass2||:new.pass_reset_key||:new.pass_reset_exp||:new.last_changed||:new.valid_until_date||:new.valid_from_date||:new.interest_in_fibreglass||:new.interest_in_woodwork||:new.interest_in_ropework||:new.interest_in_paintwork||:new.interest_in_organising_social||:new.interest_in_organising_regattas||:new.interest_in_teaching_dinghies||:new.interest_in_teaching_cats||:new.interest_in_teaching_keelboats||:new.interest_in_teaching_motorboats||:new.interest_in_surveillance||:new.interest_in_towing_on_land||:new.special_talents||:new.interest_in_motors) then
				delete from membership_applications_hist where rowid = l_rid_1;
			else
				insert into membership_applications_hist (id, name, firstname, birthday, nationality, membership, temp_memb, lang1, lang2, category, work_address1, work_address2, work_towncode, work_town, work_state, work_phone, e_mail, home_addr, home_towncode, home_town, home_state, home_phone, mail_preference, favourite_mailing_post, member_entrance, cell_phone, logon_id, logon_passwd, course1, course2, print_received, submitted_date, last_updated_date, gender, logon_pass2, pass_reset_key, pass_reset_exp, last_changed, valid_until_date, valid_from_date, interest_in_fibreglass, interest_in_woodwork, interest_in_ropework, interest_in_paintwork, interest_in_organising_social, interest_in_organising_regattas, interest_in_teaching_dinghies, interest_in_teaching_cats, interest_in_teaching_keelboats, interest_in_teaching_motorboats, interest_in_surveillance, interest_in_towing_on_land, special_talents, interest_in_motors,  op_type, create_time_utc, transaction_id, module, action, client_info)
				values (:new.id, :new.name, :new.firstname, :new.birthday, :new.nationality, :new.membership, :new.temp_memb, :new.lang1, :new.lang2, :new.category, :new.work_address1, :new.work_address2, :new.work_towncode, :new.work_town, :new.work_state, :new.work_phone, :new.e_mail, :new.home_addr, :new.home_towncode, :new.home_town, :new.home_state, :new.home_phone, :new.mail_preference, :new.favourite_mailing_post, :new.member_entrance, :new.cell_phone, :new.logon_id, :new.logon_passwd, :new.course1, :new.course2, :new.print_received, :new.submitted_date, :new.last_updated_date, :new.gender, :new.logon_pass2, :new.pass_reset_key, :new.pass_reset_exp, :new.last_changed, :new.valid_until_date, :new.valid_from_date, :new.interest_in_fibreglass, :new.interest_in_woodwork, :new.interest_in_ropework, :new.interest_in_paintwork, :new.interest_in_organising_social, :new.interest_in_organising_regattas, :new.interest_in_teaching_dinghies, :new.interest_in_teaching_cats, :new.interest_in_teaching_keelboats, :new.interest_in_teaching_motorboats, :new.interest_in_surveillance, :new.interest_in_towing_on_land, :new.special_talents, :new.interest_in_motors,  'I',                                 sysdate,
                                dbms_transaction.local_transaction_id,
                                sys_context('userenv', 'module'),
                                sys_context('userenv', 'action'),
                                coalesce(sys_context('userenv', 'client_info'), sys_context('USERENV', 'OS_USER')
	 ...
	 when updating then 
			if 
				...
				(:old.firstname is null and :new.firstname is not null) or
				(:old.firstname is not null and :new.firstname is null) or
				(:old.birthday != :new.birthday) or
				(:old.birthday is null and :new.birthday is not null) or
				(:old.birthday is not null and :new.birthday is null) or
				(:old.nationality != :new.nationality) or
				(:old.nationality is null and :new.nationality is not null) or
				(:old.nationality is not null and :new.nationality is null) or
				(:old.membership != :new.membership) or
				(:old.membership is null and :new.membership is not null) or
				(:old.membership is not null and :new.membership is null) or
				(:old.temp_memb != :new.temp_memb) or
				(:old.temp_memb is null and :new.temp_memb is not null) or
				(:old.temp_memb is not null and :new.temp_memb is null) or
				(:old.lang1 != :new.lang1) or
				(:old.lang1 is null and :new.lang1 is not null) or
				(:old.lang1 is not null and :new.lang1 is null) or
				(:old.lang2 != :new.lang2) or
				(:old.lang2 is null and :new.lang2 is not null) or
				(:old.lang2 is not null and :new.lang2 is null) or
				...
				(:old.work_address1 != :new.work_address1) or
				(:old.work_address1 is null and :new.work_address1 is not null) or
				(:old.work_address1 is not null and :new.work_address1 is null) or
				(:old.work_address2 != :new.work_address2) or
				(:old.work_address2 is null and :new.work_address2 is not null) or
				(:old.work_address2 is not null and :new.work_address2 is null) or
				(:old.work_towncode != :new.work_towncode) or
				(:old.work_towncode is null and :new.work_towncode is not null) or
				(:old.work_towncode is not null and :new.work_towncode is null) or
				(:old.work_town != :new.work_town) or
				(:old.work_town is null and :new.work_town is not null) or
				(:old.work_town is not null and :new.work_town is null) or
				(:old.work_state != :new.work_state) or
				(:old.work_state is null and :new.work_state is not null) or
				(:old.work_state is not null and :new.work_state is null) or
				(:old.work_phone != :new.work_phone) or
				(:old.work_phone is null and :new.work_phone is not null) or
				(:old.work_phone is not null and :new.work_phone is null) or
				(:old.e_mail != :new.e_mail) or
				(:old.e_mail is null and :new.e_mail is not null) or
				(:old.e_mail is not null and :new.e_mail is null) or
				(:old.home_addr != :new.home_addr) or
				(:old.home_addr is null and :new.home_addr is not null) or
				(:old.home_addr is not null and :new.home_addr is null) or
				(:old.home_towncode != :new.home_towncode) or
				(:old.home_towncode is null and :new.home_towncode is not null) or
				(:old.home_towncode is not null and :new.home_towncode is null) or
				(:old.home_town != :new.home_town) or
				(:old.home_town is null and :new.home_town is not null) or
				(:old.home_town is not null and :new.home_town is null) or
				(:old.home_state != :new.home_state) or
				(:old.home_state is null and :new.home_state is not null) or
				(:old.home_state is not null and :new.home_state is null) or
				(:old.home_phone != :new.home_phone) or
				(:old.home_phone is null and :new.home_phone is not null) or
				(:old.home_phone is not null and :new.home_phone is null) or
				(:old.mail_preference != :new.mail_preference) or
				(:old.mail_preference is null and :new.mail_preference is not null) or
				(:old.mail_preference is not null and :new.mail_preference is null) or
				(:old.favourite_mailing_post != :new.favourite_mailing_post) or
				(:old.favourite_mailing_post is null and :new.favourite_mailing_post is not null) or
				(:old.favourite_mailing_post is not null and :new.favourite_mailing_post is null) or
				(:old.member_entrance != :new.member_entrance) or
				(:old.member_entrance is null and :new.member_entrance is not null) or
				(:old.member_entrance is not null and :new.member_entrance is null) or
				(:old.cell_phone != :new.cell_phone) or
				(:old.cell_phone is null and :new.cell_phone is not null) or
				(:old.cell_phone is not null and :new.cell_phone is null) or
				(:old.logon_id != :new.logon_id) or
				(:old.logon_id is null and :new.logon_id is not null) or
				(:old.logon_id is not null and :new.logon_id is null) or
				(:old.logon_passwd != :new.logon_passwd) or
				(:old.logon_passwd is null and :new.logon_passwd is not null) or
				(:old.logon_passwd is not null and :new.logon_passwd is null) or
				(:old.course1 != :new.course1) or
				(:old.course1 is null and :new.course1 is not null) or
				(:old.course1 is not null and :new.course1 is null) or
				(:old.course2 != :new.course2) or
				(:old.course2 is null and :new.course2 is not null) or
				(:old.course2 is not null and :new.course2 is null) or
				(:old.print_received != :new.print_received) or
				(:old.print_received is null and :new.print_received is not null) or
				(:old.print_received is not null and :new.print_received is null) or
				(:old.submitted_date != :new.submitted_date) or
				(:old.submitted_date is null and :new.submitted_date is not null) or
				(:old.submitted_date is not null and :new.submitted_date is null) or
				(:old.last_updated_date != :new.last_updated_date) or
				(:old.last_updated_date is null and :new.last_updated_date is not null) or
				(:old.last_updated_date is not null and :new.last_updated_date is null) or
				(:old.gender != :new.gender) or
				(:old.gender is null and :new.gender is not null) or
				(:old.gender is not null and :new.gender is null) or
				(:old.logon_pass2 != :new.logon_pass2) or
				(:old.logon_pass2 is null and :new.logon_pass2 is not null) or
				(:old.logon_pass2 is not null and :new.logon_pass2 is null) or
				(:old.pass_reset_key != :new.pass_reset_key) or
				(:old.pass_reset_key is null and :new.pass_reset_key is not null) or
				(:old.pass_reset_key is not null and :new.pass_reset_key is null) or
				(:old.pass_reset_exp != :new.pass_reset_exp) or
				(:old.pass_reset_exp is null and :new.pass_reset_exp is not null) or
				(:old.pass_reset_exp is not null and :new.pass_reset_exp is null) or
				(:old.last_changed != :new.last_changed) or
				(:old.last_changed is null and :new.last_changed is not null) or
				(:old.last_changed is not null and :new.last_changed is null) or
				(:old.valid_until_date != :new.valid_until_date) or
				(:old.valid_until_date is null and :new.valid_until_date is not null) or
				(:old.valid_until_date is not null and :new.valid_until_date is null) or
				(:old.valid_from_date != :new.valid_from_date) or
				(:old.valid_from_date is null and :new.valid_from_date is not null) or
				(:old.valid_from_date is not null and :new.valid_from_date is null) or
				(:old.interest_in_fibreglass != :new.interest_in_fibreglass) or
				(:old.interest_in_fibreglass is null and :new.interest_in_fibreglass is not null) or
				(:old.interest_in_fibreglass is not null and :new.interest_in_fibreglass is null) or
				(:old.interest_in_woodwork != :new.interest_in_woodwork) or
				(:old.interest_in_woodwork is null and :new.interest_in_woodwork is not null) or
				(:old.interest_in_woodwork is not null and :new.interest_in_woodwork is null) or
				(:old.interest_in_ropework != :new.interest_in_ropework) or
				(:old.interest_in_ropework is null and :new.interest_in_ropework is not null) or
				(:old.interest_in_ropework is not null and :new.interest_in_ropework is null) or
				(:old.interest_in_paintwork != :new.interest_in_paintwork) or
				(:old.interest_in_paintwork is null and :new.interest_in_paintwork is not null) or
				(:old.interest_in_paintwork is not null and :new.interest_in_paintwork is null) or
				(:old.interest_in_organising_social != :new.interest_in_organising_social) or
				(:old.interest_in_organising_social is null and :new.interest_in_organising_social is not null) or
				(:old.interest_in_organising_social is not null and :new.interest_in_organising_social is null) or
				(:old.interest_in_organising_regattas != :new.interest_in_organising_regattas) or
				(:old.interest_in_organising_regattas is null and :new.interest_in_organising_regattas is not null) or
				(:old.interest_in_organising_regattas is not null and :new.interest_in_organising_regattas is null) or
				(:old.interest_in_teaching_dinghies != :new.interest_in_teaching_dinghies) or
				(:old.interest_in_teaching_dinghies is null and :new.interest_in_teaching_dinghies is not null) or
				(:old.interest_in_teaching_dinghies is not null and :new.interest_in_teaching_dinghies is null) or
				(:old.interest_in_teaching_cats != :new.interest_in_teaching_cats) or
				(:old.interest_in_teaching_cats is null and :new.interest_in_teaching_cats is not null) or
				(:old.interest_in_teaching_cats is not null and :new.interest_in_teaching_cats is null) or
				(:old.interest_in_teaching_keelboats != :new.interest_in_teaching_keelboats) or
				(:old.interest_in_teaching_keelboats is null and :new.interest_in_teaching_keelboats is not null) or
				(:old.interest_in_teaching_keelboats is not null and :new.interest_in_teaching_keelboats is null) or
				(:old.interest_in_teaching_motorboats != :new.interest_in_teaching_motorboats) or
				(:old.interest_in_teaching_motorboats is null and :new.interest_in_teaching_motorboats is not null) or
				(:old.interest_in_teaching_motorboats is not null and :new.interest_in_teaching_motorboats is null) or
				(:old.interest_in_surveillance != :new.interest_in_surveillance) or
				(:old.interest_in_surveillance is null and :new.interest_in_surveillance is not null) or
				(:old.interest_in_surveillance is not null and :new.interest_in_surveillance is null) or
				(:old.interest_in_towing_on_land != :new.interest_in_towing_on_land) or
				(:old.interest_in_towing_on_land is null and :new.interest_in_towing_on_land is not null) or
				(:old.interest_in_towing_on_land is not null and :new.interest_in_towing_on_land is null) or
				(:old.special_talents != :new.special_talents) or
				(:old.special_talents is null and :new.special_talents is not null) or
				(:old.special_talents is not null and :new.special_talents is null) or
				(:old.interest_in_motors != :new.interest_in_motors) or
				(:old.interest_in_motors is null and :new.interest_in_motors is not null) or
				(:old.interest_in_motors is not null and :new.interest_in_motors is null) then

				insert into membership_applications_hist (id, name, firstname, birthday, nationality, membership, temp_memb, lang1, lang2, category, work_address1, work_address2, work_towncode, work_town, work_state, work_phone, e_mail, home_addr, home_towncode, home_town, home_state, home_phone, mail_preference, favourite_mailing_post, member_entrance, cell_phone, logon_id, logon_passwd, course1, course2, print_received, submitted_date, last_updated_date, gender, logon_pass2, pass_reset_key, pass_reset_exp, last_changed, valid_until_date, valid_from_date, interest_in_fibreglass, interest_in_woodwork, interest_in_ropework, interest_in_paintwork, interest_in_organising_social, interest_in_organising_regattas, interest_in_teaching_dinghies, interest_in_teaching_cats, interest_in_teaching_keelboats, interest_in_teaching_motorboats, interest_in_surveillance, interest_in_towing_on_land, special_talents, interest_in_motors,  op_type, create_time_utc, transaction_id, module, action, client_info)
				values (:new.id, :new.name, :new.firstname, :new.birthday, :new.nationality, :new.membership, :new.temp_memb, :new.lang1, :new.lang2, :new.category, :new.work_address1, :new.work_address2, :new.work_towncode, :new.work_town, :new.work_state, :new.work_phone, :new.e_mail, :new.home_addr, :new.home_towncode, :new.home_town, :new.home_state, :new.home_phone, :new.mail_preference, :new.favourite_mailing_post, :new.member_entrance, :new.cell_phone, :new.logon_id, :new.logon_passwd, :new.course1, :new.course2, :new.print_received, :new.submitted_date, :new.last_updated_date, :new.gender, :new.logon_pass2, :new.pass_reset_key, :new.pass_reset_exp, :new.last_changed, :new.valid_until_date, :new.valid_from_date, :new.interest_in_fibreglass, :new.interest_in_woodwork, :new.interest_in_ropework, :new.interest_in_paintwork, :new.interest_in_organising_social, :new.interest_in_organising_regattas, :new.interest_in_teaching_dinghies, :new.interest_in_teaching_cats, :new.interest_in_teaching_keelboats, :new.interest_in_teaching_motorboats, :new.interest_in_surveillance, :new.interest_in_towing_on_land, :new.special_talents, :new.interest_in_motors,  'U',                             sysdate,
                            dbms_transaction.local_transaction_id,
                            sys_context('userenv', 'module'),
                            sys_context('userenv', 'action'),
                            coalesce(sys_context('userenv', 'client_info'), sys_context('USERENV', 'OS_USER')
	 ...
	 when deleting then 
		insert into membership_applications_hist (id, name, firstname, birthday, nationality, membership, temp_memb, lang1, lang2, category, work_address1, work_address2, work_towncode, work_town, work_state, work_phone, e_mail, home_addr, home_towncode, home_town, home_state, home_phone, mail_preference, favourite_mailing_post, member_entrance, cell_phone, logon_id, logon_passwd, course1, course2, print_received, submitted_date, last_updated_date, gender, logon_pass2, pass_reset_key, pass_reset_exp, last_changed, valid_until_date, valid_from_date, interest_in_fibreglass, interest_in_woodwork, interest_in_ropework, interest_in_paintwork, interest_in_organising_social, interest_in_organising_regattas, interest_in_teaching_dinghies, interest_in_teaching_cats, interest_in_teaching_keelboats, interest_in_teaching_motorboats, interest_in_surveillance, interest_in_towing_on_land, special_talents, interest_in_motors,  op_type, create_time_utc, transaction_id, module, action, client_info)
		values (:old.id, :old.name, :old.firstname, :old.birthday, :old.nationality, :old.membership, :old.temp_memb, :old.lang1, :old.lang2, :old.category, :old.work_address1, :old.work_address2, :old.work_towncode, :old.work_town, :old.work_state, :old.work_phone, :old.e_mail, :old.home_addr, :old.home_towncode, :old.home_town, :old.home_state, :old.home_phone, :old.mail_preference, :old.favourite_mailing_post, :old.member_entrance, :old.cell_phone, :old.logon_id, :old.logon_passwd, :old.course1, :old.course2, :old.print_received, :old.submitted_date, :old.last_updated_date, :old.gender, :old.logon_pass2, :old.pass_reset_key, :old.pass_reset_exp, :old.last_changed, :old.valid_until_date, :old.valid_from_date, :old.interest_in_fibreglass, :old.interest_in_woodwork, :old.interest_in_ropework, :old.interest_in_paintwork, :old.interest_in_organising_social, :old.interest_in_organising_regattas, :old.interest_in_teaching_dinghies, :old.interest_in_teaching_cats, :old.interest_in_teaching_keelboats, :old.interest_in_teaching_motorboats, :old.interest_in_surveillance, :old.interest_in_towing_on_land, :old.special_talents, :old.interest_in_motors,  'D',                             sysdate,
                            dbms_transaction.local_transaction_id,
                            sys_context('userenv', 'module'),
                            sys_context('userenv', 'action'),
                            coalesce(sys_context('userenv', 'client_info'), sys_context('USERENV', 'OS_USER')
	...
	exception 
		when others then
			raise_application_error(-20001, 'Error in MEMBERSHIP_APPLICATIONS_HIST trigger. Err: ' || dbms_utility.format_error_stack);
	end;
end after each row;

end MEMBERSHIP_APPLICATIONS_HIST;
/
ALTER TRIGGER "MEMBERSHIP_APPLICATIONS_HIST" ENABLE;
--------------------------------------------------------
--  DDL for Trigger RESERVATIONS_EDITED
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "RESERVATIONS_EDITED" 
AFTER DELETE OR INSERT OR UPDATE ON ycc.RESERVATIONS 
FOR EACH ROW
DECLARE
    D DATE;
    R_ID NUMBER;
...
--------------------------------------------------------
--  DDL for Trigger RESERVATIONS_HIST
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "RESERVATIONS_HIST" for insert or update or delete on reservations
compound trigger

l_non_key_data clob;
l_stmt_op_type varchar2(1);
l_op_type_1 reservations_hist.op_type%type;
l_op_type_2 reservations_hist.op_type%type;
l_rid_1 rowid;
l_rid_2 rowid;
...
begin
	...
	case
	 when inserting then 
		...
		if l_op_type_1 = 'D' then
			select boat_id||owner_id||label||day||period||locked||deleted||modified
			into l_non_key_data
			from reservations_hist
			where rowid = l_rid_1;

			if l_non_key_data = to_char(:new.boat_id||:new.owner_id||:new.label||:new.day||:new.period||:new.locked||:new.deleted||:new.modified) then
				delete from reservations_hist where rowid = l_rid_1;
			else
				insert into reservations_hist (res_id, boat_id, owner_id, label, day, period, locked, deleted, modified,  op_type, create_time_utc, transaction_id, module, action, client_info)
				values (:new.res_id, :new.boat_id, :new.owner_id, :new.label, :new.day, :new.period, :new.locked, :new.deleted, :new.modified,  'I', sysdate, dbms_transaction.local_transaction_id, sys_context('userenv', 'module'), sys_context('userenv', 'action'), coalesce(sys_context('userenv', 'client_info'), sys_context('USERENV', 'OS_USER')||'@'||sys_context('USERENV', 'HOST')||' via '||sys_context('USERENV', 'SESSION_USER')));
			end if;
	 ...
	 when updating then 
			if 
				(:old.res_id != :new.res_id) or
				(:old.res_id is null and :new.res_id is not null) or
				(:old.res_id is not null and :new.res_id is null) or
				(:old.boat_id != :new.boat_id) or
				(:old.boat_id is null and :new.boat_id is not null) or
				(:old.boat_id is not null and :new.boat_id is null) or
				(:old.owner_id != :new.owner_id) or
				(:old.owner_id is null and :new.owner_id is not null) or
				(:old.owner_id is not null and :new.owner_id is null) or
				(:old.label != :new.label) or
				(:old.label is null and :new.label is not null) or
				(:old.label is not null and :new.label is null) or
				(:old.day != :new.day) or
				(:old.day is null and :new.day is not null) or
				(:old.day is not null and :new.day is null) or
				(:old.period != :new.period) or
				(:old.period is null and :new.period is not null) or
				(:old.period is not null and :new.period is null) or
				(:old.locked != :new.locked) or
				(:old.locked is null and :new.locked is not null) or
				(:old.locked is not null and :new.locked is null) or
				(:old.deleted != :new.deleted) or
				(:old.deleted is null and :new.deleted is not null) or
				(:old.deleted is not null and :new.deleted is null) or
				(:old.modified != :new.modified) or
				(:old.modified is null and :new.modified is not null) or
				(:old.modified is not null and :new.modified is null) then

				insert into reservations_hist (res_id, boat_id, owner_id, label, day, period, locked, deleted, modified,  op_type, create_time_utc, transaction_id, module, action, client_info)
				values (:new.res_id, :new.boat_id, :new.owner_id, :new.label, :new.day, :new.period, :new.locked, :new.deleted, :new.modified,  'U', sysdate, dbms_transaction.local_transaction_id, sys_context('userenv', 'module'), sys_context('userenv', 'action'), coalesce(sys_context('userenv', 'client_info'), sys_context('USERENV', 'OS_USER')||'@'||sys_context('USERENV', 'HOST')||' via '||sys_context('USERENV', 'SESSION_USER')));

			end if;

	 when deleting then 
		insert into reservations_hist (res_id, boat_id, owner_id, label, day, period, locked, deleted, modified,  op_type, create_time_utc, transaction_id, module, action, client_info)
		values (:old.res_id, :old.boat_id, :old.owner_id, :old.label, :old.day, :old.period, :old.locked, :old.deleted, :old.modified,  'D', sysdate, dbms_transaction.local_transaction_id, sys_context('userenv', 'module'), sys_context('userenv', 'action'), coalesce(sys_context('userenv', 'client_info'), sys_context('USERENV', 'OS_USER')||'@'||sys_context('USERENV', 'HOST')||' via '||sys_context('USERENV', 'SESSION_USER')));

	end case;

	exception 
		when others then
            raise_application_error(-20001, 'Error in RESERVATIONS_HIST trigger. Err: ' || dbms_utility.format_error_stack);
	end;
end after each row;

end RESERVATIONS_HIST;
/
ALTER TRIGGER "RESERVATIONS_HIST" ENABLE;
--------------------------------------------------------
--  DDL for Trigger STATUS_EDITED
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."STATUS_EDITED" 
AFTER DELETE OR INSERT OR UPDATE ON ycc.STATUS 
FOR EACH ROW
DECLARE
    D DATE;
    R_ID NUMBER;
...
END;
/
ALTER TRIGGER "YCC"."STATUS_EDITED" ENABLE;
--------------------------------------------------------
...
/
  ...
  GRANT EXECUTE ON "CREATE_MEMBER" TO "YCCAPEX";
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Function AUTHENTICATE_TEST
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "AUTHENTICATE_TEST" (p_username in varchar2, p_password in varchar2) return varchar2 as
    url varchar2(100) := 'https://yccres.app.cern.ch/api/v1/get_token';
    req   utl_http.req;
    resp  utl_http.resp;
  ...
  begin
    ...
    content:= q'[ { "logon_id" : "]' || p_username || q'[", "password" : "]' || utl_url.escape(p_password, TRUE, 'ISO-8859-1') || q'["}]';


    utl_http.set_wallet('file:/ORA/dbs01/syscontrol/etc/WALLETS/rdbms');      
    req := UTL_HTTP.BEGIN_REQUEST(url, 'POST',' HTTP/1.1');
    UTL_HTTP.SET_HEADER(req, 'User-Agent', 'APEX YCC'); 
    ...
    select json_value(l_res, '$.logon_id') into l_user from dual;


return  l_user;

--    if lower(l_user) = lower(p_username) then
--        insert into ycc.web_logon_audit (
--          event_datetime,
--          event_type,
--          logon_id ,
--          session_id ,
...
/
  ...
  GRANT EXECUTE ON "COMPUTE_YCC_DEADLINE" TO "YCCAPEX";
--------------------------------------------------------
...
/
  ...
  GRANT EXECUTE ON "GET_CURRENT_CALENDAR_YEAR" TO "YCCAPEX";
--------------------------------------------------------
...
/
  ...
  GRANT EXECUTE ON "GET_CURRENT_MEMBERSHIP_YEAR" TO "YCCAPEX";
--------------------------------------------------------
...
/
  ...
  GRANT EXECUTE ON "GET_PREVIOUS_MEMBERSHIP_YEAR" TO "YCCAPEX";
--------------------------------------------------------
...
*/
    ...
    url varchar2(100) := 'https://yccres.app.cern.ch/res/login.pl';
    req   utl_http.req;
    resp  utl_http.resp;
    l_res varchar2(32767);
    content varchar2(4000);
...
--------------------------------------------------------
  ...
  ALTER TABLE "MD_APPLICATIONS" ADD CONSTRAINT "MD_APPLICATIONS_PK" PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "REGATTA_PARTICIPATION" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
  ALTER TABLE "REGATTA_PARTICIPATION" ADD CONSTRAINT "REGATTA_PARTICIP_UQ" UNIQUE ("MEMBER_ID", "REGATTA_ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table AUDIT_LOG
--------------------------------------------------------

  ALTER TABLE "AUDIT_LOG" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "AUDIT_LOG" MODIFY ("CREATED_AT" NOT NULL ENABLE);
  ALTER TABLE "AUDIT_LOG" MODIFY ("APPLICATION" NOT NULL ENABLE);
  ALTER TABLE "AUDIT_LOG" MODIFY ("PRINCIPAL" NOT NULL ENABLE);
  ALTER TABLE "AUDIT_LOG" MODIFY ("DESCRIPTION" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table MEMBERSHIP_APPLICATIONS_HIST
--------------------------------------------------------

  ALTER TABLE "YCC"."MEMBERSHIP_APPLICATIONS_HIST" ADD CONSTRAINT "MEMBERSHIP_APPLICATIONS_HIST_OPTYPE_CHK" CHECK ( op_type IN ( 'D', 'I', 'U' ) ) ENABLE;
  ALTER TABLE "YCC"."MEMBERSHIP_APPLICATIONS_HIST" ADD CONSTRAINT "MEMBERSHIP_APPLICATIONS_HIST_PK" PRIMARY KEY ("ID", "CREATE_TIME_UTC")
...
--------------------------------------------------------
  ...
  ALTER TABLE "INFOLICENCES" MODIFY ("HAS_TEST" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "COUNTRIES" ADD PRIMARY KEY ("COUNTRY_CODE") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table FEESRECORDS_HIST
--------------------------------------------------------

  ALTER TABLE "FEESRECORDS_HIST" ADD CONSTRAINT "feesrecords_HIST_OPTYPE_CHK" CHECK ( op_type IN ( 'D', 'I', 'U' ) ) ENABLE;
  ALTER TABLE "FEESRECORDS_HIST" ADD CONSTRAINT "feesrecords_HIST_PK" PRIMARY KEY ("PAYMENTID", "CREATE_TIME_UTC") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table HELPER_TASK_CATEGORIES
--------------------------------------------------------

  ALTER TABLE "YCC"."HELPER_TASK_CATEGORIES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASK_CATEGORIES" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASK_CATEGORIES" MODIFY ("SHORT_DESCRIPTION" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASK_CATEGORIES" ADD CONSTRAINT "HELPER_TASK_CATEGORIES_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table HELPERS_APP_PERMISSIONS
--------------------------------------------------------

  ALTER TABLE "YCC"."HELPERS_APP_PERMISSIONS" MODIFY ("MEMBER_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPERS_APP_PERMISSIONS" MODIFY ("PERMISSION" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPERS_APP_PERMISSIONS" ADD CONSTRAINT "HELPERS_APP_PERMISSIONS_PK" PRIMARY KEY ("MEMBER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02"  ENABLE;
  ALTER TABLE "YCC"."HELPERS_APP_PERMISSIONS" ADD CONSTRAINT "HELPERS_APP_PERMISSIONS_CHECK_PERMISSION" CHECK (permission IN ('ADMIN', 'EDITOR')) ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "TESTS" ADD PRIMARY KEY ("TEST_ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "BUVETTE" ADD PRIMARY KEY ("RES_ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table EMAIL_TEMPLATES
--------------------------------------------------------

  ALTER TABLE "EMAIL_TEMPLATES" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table COURSES_OBS
--------------------------------------------------------

  ALTER TABLE "COURSES_OBS" MODIFY ("MEMBER_ID" NOT NULL ENABLE);
  ALTER TABLE "COURSES_OBS" ADD CONSTRAINT "COURSES_PK" PRIMARY KEY ("MEMBER_ID", "CLASS_ID") USING INDEX "COURSES_PK"  ENABLE;
--------------------------------------------------------
--  Constraints for Table HELPER_TASKS
--------------------------------------------------------

  ALTER TABLE "HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_MARKED_AS_DONE_FIELDS" CHECK ( (marked_as_done_at IS     NULL AND marked_as_done_by_id IS     NULL)
             OR (marked_as_done_at IS NOT NULL AND marked_as_done_by_id IS NOT NULL) ) ENABLE;
  ALTER TABLE "HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_VALIDATED_FIELDS" CHECK ( (validated_at IS     NULL AND validated_by_id IS     NULL)
             OR (validated_at IS NOT NULL AND validated_by_id IS NOT NULL) ) ENABLE;
  ALTER TABLE "HELPER_TASKS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASKS" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASKS" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASKS" MODIFY ("SHORT_DESCRIPTION" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASKS" MODIFY ("CONTACT_ID" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASKS" MODIFY ("URGENT" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASKS" MODIFY ("HELPER_MIN_COUNT" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASKS" MODIFY ("HELPER_MAX_COUNT" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASKS" MODIFY ("PUBLISHED" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_PK" PRIMARY KEY ("ID") USING INDEX  ENABLE;
  ALTER TABLE "HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_TIMING" CHECK ("STARTS_AT" IS NOT NULL AND "ENDS_AT" IS NOT NULL AND "DEADLINE" IS NULL AND "STARTS_AT"<"ENDS_AT" OR "STARTS_AT" IS NULL AND "ENDS_AT" IS NULL AND "DEADLINE" IS NOT NULL) ENABLE;
  ALTER TABLE "HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_CAPTAIN_FIELDS" CHECK ("CAPTAIN_ID" IS NULL AND "CAPTAIN_SIGNED_UP_AT" IS NULL OR "CAPTAIN_ID" IS NOT NULL AND "CAPTAIN_SIGNED_UP_AT" IS NOT NULL) ENABLE;
  ALTER TABLE "HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_HELPER_MIN_MAX_COUNT" CHECK (0<="HELPER_MIN_COUNT" AND "HELPER_MIN_COUNT"<="HELPER_MAX_COUNT") ENABLE;
--------------------------------------------------------
--  Constraints for Table HELPER_TASK_HELPERS
--------------------------------------------------------

  ALTER TABLE "HELPER_TASK_HELPERS" MODIFY ("TASK_ID" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASK_HELPERS" MODIFY ("MEMBER_ID" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASK_HELPERS" MODIFY ("SIGNED_UP_AT" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASK_HELPERS" ADD CONSTRAINT "HELPER_TASK_HELPERS_PK" PRIMARY KEY ("TASK_ID", "MEMBER_ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "REGATTAS_EXT" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table RESERVATIONS_HIST
--------------------------------------------------------

  ALTER TABLE "RESERVATIONS_HIST" ADD CONSTRAINT "RESERVATIONS_HIST_OPTYPE_CHK" CHECK ( op_type IN ( 'D', 'I', 'U' ) ) ENABLE;
  ALTER TABLE "RESERVATIONS_HIST" ADD CONSTRAINT "RESERVATIONS_HIST_PK" PRIMARY KEY ("RES_ID", "CREATE_TIME_UTC") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table INFOLICENCES_BACKUP
--------------------------------------------------------

  ALTER TABLE "INFOLICENCES_BACKUP" MODIFY ("INFOID" NOT NULL ENABLE);
  ALTER TABLE "INFOLICENCES_BACKUP" MODIFY ("DESCRIPTION" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."CLUB_EVENT" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT" MODIFY ("ACTIVE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT" MODIFY ("DESCRIPTION" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT" MODIFY ("ORGANIZER_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT" MODIFY ("DAY" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT" MODIFY ("REGISTRATION_STARTS" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT" MODIFY ("REGISTRATION_ENDS" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT" MODIFY ("MULTIPLE_CHOICES" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "EMAIL_QUEUE_TABLE" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."BOAT_MAINTAINER" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_MAINTAINER" MODIFY ("BOAT_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_MAINTAINER" MODIFY ("MEMBER_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_MAINTAINER" MODIFY ("PRIORITY" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_MAINTAINER" MODIFY ("START_DATE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_MAINTAINER" MODIFY ("LAST_UPDATE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_MAINTAINER" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
--  Constraints for Table CLUB_EVENT_SESSION
--------------------------------------------------------

  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("DESCRIPTION" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("START_TIME" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("END_TIME" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("EVENT_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("MULTIPLE_CHOICES" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("ALLOCATION_METHOD" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("SESSION_TYPE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02"  ENABLE;
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("ACTIVE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" MODIFY ("TITLE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LICENCES" ADD CONSTRAINT "LICENCE_PK" PRIMARY KEY ("LICENCE_ID", "MEMBER_ID") USING INDEX "LICENCE_PK"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "REGATTA_SERIES_EXT" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "REGATTAS_IN_SERIES" ADD PRIMARY KEY ("REGATTA_IN_SERIES_ID") USING INDEX  ENABLE;
  ALTER TABLE "REGATTAS_IN_SERIES" ADD CONSTRAINT "REGATTAS_IN_SERIES_UQ" UNIQUE ("REGATTA_ID", "SERIES_ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "STATUS" ADD CONSTRAINT "STATUS_PK" PRIMARY KEY ("STAT_ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MD_APPLICATIONFILES" ADD CONSTRAINT "MD_APPLICATIONFILES_PK" PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table USERLIST
--------------------------------------------------------

  ALTER TABLE "USERLIST" ADD UNIQUE ("USERNAME") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MEMBERS_XX_EMPTY" ADD CONSTRAINT "MEMBERS_XX_PK" PRIMARY KEY ("ID") USING INDEX "MEMBERS_XX_PK"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."DOCUMENT_TYPES" MODIFY ("DOCUMENT_TYPE_NAME" CONSTRAINT "DOCUMENT_TYPES_DOCUMENT_TYPE_NAME_NN" NOT NULL ENABLE);
  ALTER TABLE "YCC"."DOCUMENT_TYPES" MODIFY ("DOCUMENT_TYPE_CATEGORY" CONSTRAINT "DOCUMENT_TYPES_DOCUMENT_TYPE_CATEGORY_NN" NOT NULL ENABLE);
  ALTER TABLE "YCC"."DOCUMENT_TYPES" ADD CONSTRAINT "DOCUMENT_TYPES_DOCUMENT_TYPE_CATEGORY_CHK" CHECK (document_type_category in ('license', 'other')) ENABLE;
  ALTER TABLE "YCC"."DOCUMENT_TYPES" ADD CONSTRAINT "DOCUMENT_TYPES_PK" PRIMARY KEY ("DOCUMENT_TYPE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
--  Constraints for Table CLUB_EVENT_RESOURCE
--------------------------------------------------------

  ALTER TABLE "YCC"."CLUB_EVENT_RESOURCE" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_RESOURCE" MODIFY ("ACTIVE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_RESOURCE" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_RESOURCE" MODIFY ("ALLOW_UPGRADE_TO_SKIPPER" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_RESOURCE" MODIFY ("SESSION_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_RESOURCE" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
--  Constraints for Table HTE_WEB_LOGON
--------------------------------------------------------

  ALTER TABLE "YCC"."HTE_WEB_LOGON" MODIFY ("RN_" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HTE_WEB_LOGON" ADD PRIMARY KEY ("RN_") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."BOAT_KEYS" ADD CONSTRAINT "BOAT_KEYS_PK" PRIMARY KEY ("KEY_NR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02"  ENABLE;
  ALTER TABLE "YCC"."BOAT_KEYS" ADD CONSTRAINT "BOAT_KEYS_UK1" UNIQUE ("BOAT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
--  Constraints for Table RENEW_TOKENS
--------------------------------------------------------

  ALTER TABLE "YCC"."RENEW_TOKENS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."RENEW_TOKENS" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."RENEW_TOKENS" MODIFY ("SECRET" NOT NULL ENABLE);
  ALTER TABLE "YCC"."RENEW_TOKENS" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "YCC"."RENEW_TOKENS" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."MD_TABLESPACES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_TABLESPACES" MODIFY ("SCHEMA_ID_FK" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_TABLESPACES" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_TABLESPACES" MODIFY ("CREATED_ON" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table MD_FILE_ARTIFACTS
--------------------------------------------------------

  ALTER TABLE "YCC"."MD_FILE_ARTIFACTS" MODIFY ("ID" CONSTRAINT "MD_APP_FILE_ART_NONULL" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_FILE_ARTIFACTS" MODIFY ("APPLICATIONFILES_ID" CONSTRAINT "MD_APPL_FILE_FK_NONULL" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_FILE_ARTIFACTS" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_FILE_ARTIFACTS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_FILE_ARTIFACTS" ADD CONSTRAINT "MD_FILE_ARTIFACTS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
--  Constraints for Table CLUB_EVENT_PARTICIPANT
--------------------------------------------------------

  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("PRIORITY" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("AS_SKIPPER" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("AS_UPGRADED_SKIPPER" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("MODIFIED" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("PREFERENCE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("PROFICIENCY" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("RESOURCE_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" MODIFY ("SESSION_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."YCCLOG" ADD CONSTRAINT "PK_YCCLOG" PRIMARY KEY ("LOG_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."DOCUMENTS" ADD CONSTRAINT "DOCUMENTS_PK" PRIMARY KEY ("DOCUMENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02"  ENABLE;
  ALTER TABLE "YCC"."DOCUMENTS" MODIFY ("MEMBER_ID" CONSTRAINT "DOCUMENTS_MEMBER_ID_NN" NOT NULL ENABLE);
  ALTER TABLE "YCC"."DOCUMENTS" MODIFY ("DOCUMENT_TYPE_ID" CONSTRAINT "DOCUMENTS_DOCUMENT_TYPE_ID_NN" NOT NULL ENABLE);
  ALTER TABLE "YCC"."DOCUMENTS" MODIFY ("DOCUMENT_VALUE" CONSTRAINT "DOCUMENTS_DOCUMENT_VALUE_NN" NOT NULL ENABLE);
  ALTER TABLE "YCC"."DOCUMENTS" MODIFY ("FILE_NAME" CONSTRAINT "DOCUMENTS_FILE_NAME_NN" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."DB_EDITS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."DB_EDITS" MODIFY ("TABLE_NAME" NOT NULL ENABLE);
  ALTER TABLE "YCC"."DB_EDITS" MODIFY ("ROW_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."DB_EDITS" MODIFY ("TIME_STAMP" NOT NULL ENABLE);
  ALTER TABLE "YCC"."DB_EDITS" ADD CONSTRAINT "DB_EDITS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."BOAT_MAINTAINER" ADD FOREIGN KEY ("BOAT_ID")
	  REFERENCES "YCC"."BOATS" ("BOAT_ID") ENABLE;
  ALTER TABLE "YCC"."BOAT_MAINTAINER" ADD FOREIGN KEY ("MEMBER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."CLASSES_OBSOLETE2001" ADD CONSTRAINT "HELPER_FK" FOREIGN KEY ("HELPER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CLUB_EVENT
--------------------------------------------------------

  ALTER TABLE "YCC"."CLUB_EVENT" ADD FOREIGN KEY ("ORGANIZER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CLUB_EVENT_PARTICIPANT
--------------------------------------------------------

  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" ADD FOREIGN KEY ("MEMBER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" ADD FOREIGN KEY ("RESOURCE_ID")
	  REFERENCES "YCC"."CLUB_EVENT_RESOURCE" ("ID") ENABLE;
  ALTER TABLE "YCC"."CLUB_EVENT_PARTICIPANT" ADD FOREIGN KEY ("SESSION_ID")
	  REFERENCES "YCC"."CLUB_EVENT_SESSION" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CLUB_EVENT_RESOURCE
--------------------------------------------------------

  ALTER TABLE "YCC"."CLUB_EVENT_RESOURCE" ADD FOREIGN KEY ("BOAT_ID")
	  REFERENCES "YCC"."BOATS" ("BOAT_ID") ENABLE;
  ALTER TABLE "YCC"."CLUB_EVENT_RESOURCE" ADD FOREIGN KEY ("SESSION_ID")
	  REFERENCES "YCC"."CLUB_EVENT_SESSION" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CLUB_EVENT_SESSION
--------------------------------------------------------

  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" ADD FOREIGN KEY ("ORGANIZER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
  ALTER TABLE "YCC"."CLUB_EVENT_SESSION" ADD FOREIGN KEY ("EVENT_ID")
	  REFERENCES "YCC"."CLUB_EVENT" ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."DOCUMENTS" ADD CONSTRAINT "DOCUMENTS_MEMBER_ID_FK" FOREIGN KEY ("MEMBER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
  ALTER TABLE "YCC"."DOCUMENTS" ADD CONSTRAINT "DOCUMENTS_DOCUMENT_TYPE_ID_FK" FOREIGN KEY ("DOCUMENT_TYPE_ID")
	  REFERENCES "YCC"."DOCUMENT_TYPES" ("DOCUMENT_TYPE_ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Ref Constraints for Table HELPERS_APP_PERMISSIONS
--------------------------------------------------------

  ALTER TABLE "YCC"."HELPERS_APP_PERMISSIONS" ADD CONSTRAINT "HELPERS_APP_PERMISSIONS_MEMBER_FK" FOREIGN KEY ("MEMBER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table HELPER_TASKS
--------------------------------------------------------

  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_MARKED_AS_DONE_BY_FK" FOREIGN KEY ("MARKED_AS_DONE_BY_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_VALIDATED_BY_FK" FOREIGN KEY ("VALIDATED_BY_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CATEGORY_FK" FOREIGN KEY ("CATEGORY_ID")
	  REFERENCES "YCC"."HELPER_TASK_CATEGORIES" ("ID") ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CONTACT_FK" FOREIGN KEY ("CONTACT_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CAPTAIN_FK" FOREIGN KEY ("CAPTAIN_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CAPTAIN_REQUIRED_LICENCE_INFO_FK" FOREIGN KEY ("CAPTAIN_REQUIRED_LICENCE_INFO_ID")
	  REFERENCES "YCC"."INFOLICENCES" ("INFOID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table HELPER_TASK_HELPERS
--------------------------------------------------------

  ALTER TABLE "YCC"."HELPER_TASK_HELPERS" ADD CONSTRAINT "HELPER_TASK_HELPERS_TASK_FK" FOREIGN KEY ("TASK_ID")
	  REFERENCES "YCC"."HELPER_TASKS" ("ID") ENABLE;
  ALTER TABLE "YCC"."HELPER_TASK_HELPERS" ADD CONSTRAINT "HELPER_TASK_HELPERS_MEMBER_FK" FOREIGN KEY ("MEMBER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."LICENCES" ADD CONSTRAINT "LICENCES_LICENCE_ID_FK" FOREIGN KEY ("LICENCE_ID")
	  REFERENCES "YCC"."INFOLICENCES" ("INFOID") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."REGATTA_PROFILES" ADD FOREIGN KEY ("MEMBER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table RENEW_TOKENS
--------------------------------------------------------

  ALTER TABLE "YCC"."RENEW_TOKENS" ADD FOREIGN KEY ("USER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
