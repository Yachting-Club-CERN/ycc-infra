...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."FEESRECORDS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 25409 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."LOTTERY_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 5145 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."LOTTERY_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence MEMBERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."MEMBERS_ID"  MINVALUE 1000 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 7522 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."MEMBERS_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence REGATTAS_EXT_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."REGATTAS_EXT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 3121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."REGATTA_PARTICIPATION_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 32916 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."REGATTA_PARTICIPATION_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence REGATTA_PROFILES_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."REGATTA_PROFILES_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 16105 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."S_EMAIL_QUEUE"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 53651 CACHE 10 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."S_LOTTERY_RESULTS"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 10241 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_LOTTERY_RESULTS" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence TEACHERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."TEACHERS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1764 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_NATIONALITY" ("ID", "LOGON_ID", "NAME", "FIRSTNAME", "WORK_PHONE", "HOME_PHONE", "CELL_PHONE", "E_MAIL", "MEMBER_ENTRANCE", "E_DESC", "CATEGORY", "NATIONALITY") AS SELECT DISTINCT ID, LOGON_ID, NAME, FIRSTNAME, WORK_PHONE,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "MEMBERS_PREVIOUS_YEAR" ("ID", "NAME", "FIRSTNAME", "E_MAIL", "MEMBERSHIP") AS SELECT DISTINCT m.ID, NAME, FIRSTNAME, E_MAIL, MEMBERSHIP FROM MEMBERS M inner join old_member_payments omp on M.ID=omp.MEMBER_ID
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "M_KEY" ("NAME", "FIRSTNAME", "LYEAR") AS SELECT name, firstname, lyear
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "STILL_JUNIORS" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY") AS SELECT id, name, firstname, birthday
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SWS_LIST_SENT" ("ID", "CATEGORY", "NAME", "FIRSTNAME", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "SWS_YEAR", "SENT_TO_SWS_DATE", "COMMENTS", "BIRTHDAY") AS SELECT 
    MEMBERS.ID, 
    MEMBERS.CATEGORY, 
    MEMBERS.NAME, 
    MEMBERS.FIRSTNAME, 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SW_TOBE_SENT" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY", "GENDER", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "LANG1", "CATEGORY") AS SELECT DISTINCT 
    MEMBERS_CURRENT.ID, 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEACHERS_LIST" ("MNAME", "FIRSTNAME", "LICENSE", "ACTIVE", "SINCE") AS SELECT 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW3" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "LANG1") AS SELECT DISTINCT 
    MEMBERS.ID, 
    MEMBERS.NAME, 
    MEMBERS.FIRSTNAME, 
    MEMBERS.BIRTHDAY, 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW4" ("ID", "NAME", "FIRSTNAME", "BIRTHDAY", "MEMBERSHIP", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "E_MAIL", "LANG1") AS SELECT DISTINCT 
    MEMBERS.ID, 
    MEMBERS.NAME, 
    MEMBERS.FIRSTNAME, 
    MEMBERS.BIRTHDAY, 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW7" ("B", "Y") AS SELECT birthday b, round(months_between(sysdate , birthday)/12) y
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW9_OBSOLETE" ("NAME", "FIRSTNAME", "YEAR_F", "PAID_DATE", "PAID_MODE", "FEE", "ENTERED_DATE", "PAYMENTID") AS SELECT MEMBERS.NAME,
    MEMBERS.FIRSTNAME,
    FEESRECORDS.YEAR_F,
    FEESRECORDS.PAID_DATE,
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "DOCUMENTS_PK" ON "DOCUMENTS" ("DOCUMENT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HELPER_TASK_CATEGORIES_PK" ON "HELPER_TASK_CATEGORIES" ("ID") ;
--------------------------------------------------------
--  DDL for Index HELPER_TASK_HELPERS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "HELPER_TASK_HELPERS_PK" ON "HELPER_TASK_HELPERS" ("TASK_ID", "MEMBER_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "RESERVATIONS_HIST_PK" ON "RESERVATIONS_HIST" ("RES_ID", "CREATE_TIME_UTC") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "MEMBERSHIP_APPLICATIONS_HIST_PK" ON "MEMBERSHIP_APPLICATIONS_HIST" ("ID", "CREATE_TIME_UTC") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "FEESRECORDS_HIST" for insert or update or delete on feesrecords
compound trigger
...
/
ALTER TRIGGER "FEESRECORDS_HIST" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "HELPER_TASKS_CHECK_CANNOT_BE_CAPTAIN_IF_ALREADY_HELPER" 
...
/
ALTER TRIGGER "HELPER_TASKS_CHECK_CANNOT_BE_CAPTAIN_IF_ALREADY_HELPER" ENABLE;
--------------------------------------------------------
--  DDL for Trigger HELPER_TASKS_CHECK_MAX_HELPER_COUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "HELPER_TASKS_CHECK_MAX_HELPER_COUNT" 
...
/
ALTER TRIGGER "HELPER_TASKS_CHECK_MAX_HELPER_COUNT" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "HELPER_TASK_HELPERS_FORBID_UPDATES" 
...
/
ALTER TRIGGER "HELPER_TASK_HELPERS_FORBID_UPDATES" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "KEYS" ADD CONSTRAINT "KEYS_PK" PRIMARY KEY ("KEY_ID", "MEMBER_ID", "KYEAR") USING INDEX "KEYS_PK"  ENABLE;
--------------------------------------------------------
--  Constraints for Table MEMBERSHIP_APPLICATIONS_HIST
--------------------------------------------------------

  ALTER TABLE "MEMBERSHIP_APPLICATIONS_HIST" ADD CONSTRAINT "MEMBERSHIP_APPLICATIONS_HIST_OPTYPE_CHK" CHECK ( op_type IN ( 'D', 'I', 'U' ) ) ENABLE;
  ALTER TABLE "MEMBERSHIP_APPLICATIONS_HIST" ADD CONSTRAINT "MEMBERSHIP_APPLICATIONS_HIST_PK" PRIMARY KEY ("ID", "CREATE_TIME_UTC") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HELPER_TASK_CATEGORIES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASK_CATEGORIES" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASK_CATEGORIES" MODIFY ("SHORT_DESCRIPTION" NOT NULL ENABLE);
  ALTER TABLE "HELPER_TASK_CATEGORIES" ADD CONSTRAINT "HELPER_TASK_CATEGORIES_PK" PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HELPERS_APP_PERMISSIONS" MODIFY ("MEMBER_ID" NOT NULL ENABLE);
  ALTER TABLE "HELPERS_APP_PERMISSIONS" MODIFY ("PERMISSION" NOT NULL ENABLE);
  ALTER TABLE "HELPERS_APP_PERMISSIONS" ADD CONSTRAINT "HELPERS_APP_PERMISSIONS_PK" PRIMARY KEY ("MEMBER_ID") USING INDEX  ENABLE;
  ALTER TABLE "HELPERS_APP_PERMISSIONS" ADD CONSTRAINT "HELPERS_APP_PERMISSIONS_CHECK_PERMISSION" CHECK (permission IN ('ADMIN', 'EDITOR')) ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "CLUB_EVENT" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT" MODIFY ("ACTIVE" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT" MODIFY ("DESCRIPTION" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT" MODIFY ("ORGANIZER_ID" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT" MODIFY ("DAY" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT" MODIFY ("REGISTRATION_STARTS" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT" MODIFY ("REGISTRATION_ENDS" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT" MODIFY ("MULTIPLE_CHOICES" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LOTTERY_RESULTS" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
  ALTER TABLE "LOTTERY_RESULTS" ADD CONSTRAINT "LOTTERY_RESULTS_UQ1" UNIQUE ("MEMBER_ID", "YEAR") USING INDEX  ENABLE;
  ALTER TABLE "LOTTERY_RESULTS" ADD CONSTRAINT "LOTTERY_RESULTS_UQ2" UNIQUE ("DRAWN_SEQ", "YEAR") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MEMBERS_DATA_HISTORY" ADD CONSTRAINT "MEMBERS_DC_PK" PRIMARY KEY ("ID", "VALID_UNTIL_DATE") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table CLUB_EVENT_SESSION
--------------------------------------------------------

  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("DESCRIPTION" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("START_TIME" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("END_TIME" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("EVENT_ID" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("MULTIPLE_CHOICES" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("ALLOCATION_METHOD" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("SESSION_TYPE" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_SESSION" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("ACTIVE" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_SESSION" MODIFY ("TITLE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "TEACHERS" ADD PRIMARY KEY ("TEACHER_ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "DEPARTMENTS" ADD PRIMARY KEY ("DEP_ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "KEYSLOG" ADD PRIMARY KEY ("KEYSLOG_ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table DOCUMENT_TYPES
--------------------------------------------------------

  ALTER TABLE "DOCUMENT_TYPES" MODIFY ("DOCUMENT_TYPE_NAME" CONSTRAINT "DOCUMENT_TYPES_DOCUMENT_TYPE_NAME_NN" NOT NULL ENABLE);
  ALTER TABLE "DOCUMENT_TYPES" MODIFY ("DOCUMENT_TYPE_CATEGORY" CONSTRAINT "DOCUMENT_TYPES_DOCUMENT_TYPE_CATEGORY_NN" NOT NULL ENABLE);
  ALTER TABLE "DOCUMENT_TYPES" ADD CONSTRAINT "DOCUMENT_TYPES_DOCUMENT_TYPE_CATEGORY_CHK" CHECK (document_type_category in ('license', 'other')) ENABLE;
  ALTER TABLE "DOCUMENT_TYPES" ADD CONSTRAINT "DOCUMENT_TYPES_PK" PRIMARY KEY ("DOCUMENT_TYPE_ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table CLUB_EVENT_RESOURCE
--------------------------------------------------------

  ALTER TABLE "CLUB_EVENT_RESOURCE" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_RESOURCE" MODIFY ("ACTIVE" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_RESOURCE" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_RESOURCE" MODIFY ("ALLOW_UPGRADE_TO_SKIPPER" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_RESOURCE" MODIFY ("SESSION_ID" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_RESOURCE" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table HTE_WEB_LOGON
--------------------------------------------------------

  ALTER TABLE "HTE_WEB_LOGON" MODIFY ("RN_" NOT NULL ENABLE);
  ALTER TABLE "HTE_WEB_LOGON" ADD PRIMARY KEY ("RN_") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "BOAT_KEYS" ADD CONSTRAINT "BOAT_KEYS_PK" PRIMARY KEY ("KEY_NR") USING INDEX  ENABLE;
  ALTER TABLE "BOAT_KEYS" ADD CONSTRAINT "BOAT_KEYS_UK1" UNIQUE ("BOAT_ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MD_FILE_ARTIFACTS" ADD CONSTRAINT "MD_FILE_ARTIFACTS_PK" PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table EMPLOYEES
--------------------------------------------------------

  ALTER TABLE "EMPLOYEES" ADD PRIMARY KEY ("EMP_ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LOTTERY_PLACES" ADD PRIMARY KEY ("KEY") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "CLASSES_OBSOLETE2001" ADD CONSTRAINT "CLASSES_PK" PRIMARY KEY ("CLASS_ID", "TEACHER_ID", "COURSE_YEAR") USING INDEX "CLASSES_PK"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "DELETED_MEMBER_APPS" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table CLUB_EVENT_PARTICIPANT
--------------------------------------------------------

  ALTER TABLE "CLUB_EVENT_PARTICIPANT" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_PARTICIPANT" MODIFY ("PRIORITY" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_PARTICIPANT" MODIFY ("AS_SKIPPER" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_PARTICIPANT" MODIFY ("AS_UPGRADED_SKIPPER" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_PARTICIPANT" MODIFY ("MODIFIED" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_PARTICIPANT" MODIFY ("RESOURCE_ID" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_PARTICIPANT" MODIFY ("SESSION_ID" NOT NULL ENABLE);
  ALTER TABLE "CLUB_EVENT_PARTICIPANT" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LOTTERY" ADD PRIMARY KEY ("ID") USING INDEX  ENABLE;
  ALTER TABLE "LOTTERY" ADD CONSTRAINT "LOTTERY_UQ" UNIQUE ("YEAR", "MEMBER_ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table MEMBERSHIP_APPLICATIONS
--------------------------------------------------------

  ALTER TABLE "MEMBERSHIP_APPLICATIONS" ADD CONSTRAINT "NEW_MEMBER_LOGON_ID_UNIQUE" UNIQUE ("LOGON_ID") USING INDEX  ENABLE;
  ...
  ALTER TABLE "MEMBERSHIP_APPLICATIONS" ADD CONSTRAINT "APPLICATIONS_PK" PRIMARY KEY ("ID") USING INDEX  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCCLOG" ADD CONSTRAINT "PK_YCCLOG" PRIMARY KEY ("LOG_ID") USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "DB_EDITS" ADD CONSTRAINT "DB_EDITS_PK" PRIMARY KEY ("ID") USING INDEX  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BA5ASSIGN_OBSOLETE
--------------------------------------------------------

  ALTER TABLE "BA5ASSIGN_OBSOLETE" ADD CONSTRAINT "BA5ASS_MEMBER_ID_FK" FOREIGN KEY ("MEMBER_ID") REFERENCES "MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
