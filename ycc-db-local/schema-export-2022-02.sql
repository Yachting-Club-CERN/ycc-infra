...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."COMMITTEE_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 860 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."COMMITTEE_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence EMAIL_TEMPLATE_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."EMAIL_TEMPLATE_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 143 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."EMAIL_TEMPLATE_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence FEESRECORDS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."FEESRECORDS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 19464 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."LOTTERY_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 4405 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."LOTTERY_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence MEMBERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."MEMBERS_ID"  MINVALUE 1000 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 6593 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."MEMBERS_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence REGATTAS_EXT_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."REGATTAS_EXT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 2621 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."REGATTA_PARTICIPATION_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 26174 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."REGATTA_PARTICIPATION_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence REGATTA_PROFILES_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."REGATTA_PROFILES_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 12224 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."S_EMAIL_QUEUE"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 43312 CACHE 10 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_EMAIL_QUEUE" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence S_IMPORTANT_DATES
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."S_IMPORTANT_DATES"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 261 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_IMPORTANT_DATES" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence S_LOTTERY_RESULTS
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."S_LOTTERY_RESULTS"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 9681 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_LOTTERY_RESULTS" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence TEACHERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."TEACHERS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1304 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "YCC"."NATIONALITIES"
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02" ;
  GRANT SELECT ON "YCC"."NATIONALITIES" TO "YCCAPEX";
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."MEMBERS_RIGHTS" ("NAME", "FIRSTNAME", "RES", "Key", "MEM", "LIC", "RIG", "MODIFIED", "COMMENTS") AS
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."NATIONALITIES" MODIFY ("NATID" NOT NULL ENABLE);
--------------------------------------------------------
