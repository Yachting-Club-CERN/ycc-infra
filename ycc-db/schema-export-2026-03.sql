--------------------------------------------------------
--  File created - Sunday-March-29-2026   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."COMMITTEE_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1020 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."FEESRECORDS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 26810 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."LOTTERY_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 5393 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."LOTTERY_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence MEMBERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."MEMBERS_ID"  MINVALUE 1000 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 7862 CACHE 2 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."MEMBERS_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence REGATTAS_EXT_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."REGATTAS_EXT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 3301 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."REGATTA_PARTICIPATION_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 34718 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."REGATTA_PARTICIPATION_ID" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence REGATTA_PROFILES_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."REGATTA_PROFILES_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 16886 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "YCC"."S_EMAIL_QUEUE"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 56981 CACHE 10 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_EMAIL_QUEUE" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence S_IMPORTANT_DATES
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."S_IMPORTANT_DATES"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 341 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_IMPORTANT_DATES" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence S_LOTTERY_RESULTS
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."S_LOTTERY_RESULTS"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 10661 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  GRANT SELECT ON "YCC"."S_LOTTERY_RESULTS" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for Sequence TEACHERS_ID
--------------------------------------------------------

   CREATE SEQUENCE  "YCC"."TEACHERS_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1904 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Table BOAT_WARNING
--------------------------------------------------------

  CREATE TABLE "YCC"."BOAT_WARNING" 
   (	"ID" NUMBER(*,0), 
	"BOAT_ID" NUMBER(*,0), 
...
--------------------------------------------------------
 ...
 LOB ("DOCUMENT_VALUE") STORE AS SECUREFILE (
  ...
  PCTINCREASE 0
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
  GRANT SELECT ON "YCC"."DOCUMENTS" TO "YCCAPEX";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Table HELPERS_2026
--------------------------------------------------------

  CREATE TABLE "YCC"."HELPERS_2026" 
...
--------------------------------------------------------
--  DDL for Table MEMBERS_SUI_LICENSES_2025
--------------------------------------------------------

  CREATE TABLE "YCC"."MEMBERS_SUI_LICENSES_2025" 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02" ;
  GRANT SELECT ON "YCC"."MEMBER_ROLES" TO "YCCAPEX";
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "YCC"."TEMP_LICENSES" 
   (	"LICENSE" NUMBER, 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02" ;
  GRANT SELECT ON "YCC"."WEB_LOGON" TO "YCCREAD";
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."BOATS_ON_KEYS_DISTRIBUTOR" ("BOAT_ID", "NAME", "TYPE", "LICENSE", "CLASS", "TABLE_POS", "KEY_NR", "VIRTUAL") AS 
  SELECT B.BOAT_ID, B.NAME, B.TYPE, B.LICENSE, B.CLASS, B.TABLE_POS, K.KEY_NR, K.VIRTUAL
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."BOAT_LOGS" ("BOAT_NAME", "LOG_DATE", "AUTHOR", "STATUS", "SKIPPER", "CREW", "WIND", "LOG") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."HELPERS_RESERVATIONS_2023_V" ("ID", "FIRSTNAME", "NAME", "RESERVATION_NO", "SPECIAL_RESERVATION_NO", "HELP_NO") AS 
  with number_helps_v as (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."HELPERS_RESERVATIONS_2024_V" ("ID", "FIRSTNAME", "NAME", "RESERVATION_NO", "SPECIAL_RESERVATION_NO", "HELP_NO") AS 
  with number_helps_v as (
select member_id, count(*) number_helps from (
    select member_id from helper_task_helpers hth
    join helper_tasks ht on ht.id = hth.task_id
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."KEY_LOGS_VIEW" ("K_ID", "B_ID", "NAME", "FIRSTNAME", "BNAME", "TAKEN", "RETURNED") AS 
  SELECT K.KEYSLOG_ID AS K_ID, B.BOAT_ID AS B_ID, M.NAME AS NAME, M.FIRSTNAME, B.NAME AS BNAME,
...
--------------------------------------------------------
--  DDL for View LOTTERY_PAYEMENTS_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."LOTTERY_PAYEMENTS_V" ("ID", "MEMBER_ID", "AMOUNT", "DESCRIPTION") AS 
  select rownum id, member_id, amount, description from (
select member_id, 170 amount, 'Course Fee' description from lottery_ranking where (order1 is not null and score <= available_places) or (order2 is not null and score <= available_places)
minus
select member_id, fee, payment_reason from feesrecords where payment_reason = 'Course Fee' and year_f  = TO_CHAR(SYSDATE, 'YYYY'))
;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."MAINTAINERS" ("ID", "PRIORITY", "BOAT_ID", "TABLE_POS", "B_NAME", "B_TYPE", "B_LICENCE", "B_CLASS", "M_ID", "M_NAME", "M_FIRSTNAME", "M_EMAIL") AS 
  SELECT 
...
;
--------------------------------------------------------
--  DDL for View MEMBERS_2026_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."MEMBERS_2026_V" ("ID", "NAME", "FIRSTNAME") AS 
  select distinct m.id, m.name, m.firstname from feesrecords f
join members m on m.id = f.member_id
where f.year_f = 2026 and f.paid_date < '01.01.26 00:00:00'
;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."MEMBERS_WITH_NON_STANDARD_NAMES" ("ID", "NAME", "FIRSTNAME") AS 
  SELECT 
...
--------------------------------------------------------
--  DDL for View MEMBER_LICENSES_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."MEMBER_LICENSES_V" ("ID", "USERNAME", "FULL_NAME", "DOCUMENT_TYPE_NAME", "FILE_NAME", "CONTENT") AS 
  select m.id, l.logon_id username, m.firstname || ' ' || m.name full_name, dt.document_type_name, d.file_name, dbms_lob.getlength(document_value) content

from documents d
join document_types dt on d.document_type_id = dt.document_type_id
join members m on m.id = d.member_id
join web_logon l on l.member_id = m.id
;
  GRANT SELECT ON "YCC"."MEMBER_LICENSES_V" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View MEMBER_RECORDS_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."MEMBER_RECORDS_V" ("ID", "LOGON_ID", "NAME", "FIRSTNAME", "GENDER", "BIRTHDAY", "CATEGORY", "E_MAIL", "Mobile phone", "WhatsApp phone", "Other phone", "HOME_ADDR", "HOME_TOWNCODE", "HOME_TOWN", "HOME_STATE", "NATIONALITY", "LANG1", "MEMBERSHIP", "VALID_FROM_DATE", "VALID_UNTIL_DATE", "FAVOURITE_MAILING_POST", "MEMBER_ENTRANCE", "LAST_UPDATED_DATE", "IS_ACTIVE", "ALL_LICENCES", "ACTIVE_LICENCES") AS 
  with am as (
select distinct id, name, firstname, membership, year_f, 'Yes' as is_active from ycc.members m
left join ycc.feesrecords f on f.member_id = m.id
where membership != 'H' and (year_f = get_current_membership_year() or year_f = to_char(sysdate, 'YYYY'))),
honorary as (
select distinct id, name, firstname, membership, 'Yes' as is_active from ycc.members m
left join ycc.feesrecords f on f.member_id = m.id
where membership = 'H'),
all_licences_v as (
select member_id, LISTAGG(nlicence, ', ') WITHIN GROUP (ORDER BY nlicence) all_licences from ycc.licences l
join ycc.infolicences il on l.licence_id = il.infoid
group by member_id),
active_licences_v as (
select member_id, LISTAGG(nlicence, ', ') WITHIN GROUP (ORDER BY nlicence) active_licences from ycc.licences l
join ycc.infolicences il on l.licence_id = il.infoid
where l.status = 1
group by member_id)
select md.ID, 
...
md.CATEGORY,
md.E_MAIL,
md.CELL_PHONE "Mobile phone",
md.WORK_PHONE "WhatsApp phone",
md.HOME_PHONE "Other phone",
md.HOME_ADDR,
md.HOME_TOWNCODE,
md.HOME_TOWN,
md.HOME_STATE,
...
md.VALID_FROM_DATE,
md.VALID_UNTIL_DATE,
md.FAVOURITE_MAILING_POST,
md.MEMBER_ENTRANCE,
md.LAST_UPDATED_DATE,
coalesce(am.is_active, 'No') is_active,
all_licences_v.all_licences,
active_licences_v.active_licences
from YCC.MEMBER_DATA md
left join am on am.id = md.id
left join honorary h on h.id = md.id
left join all_licences_v  on all_licences_v.member_id = md.id
left join active_licences_v on active_licences_v.member_id = md.id
;
  GRANT SELECT ON "YCC"."MEMBER_RECORDS_V" TO "YCCAPEX";
--------------------------------------------------------
--  DDL for View MEMBER_SUISSE_LICENCES_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "YCC"."MEMBER_SUISSE_LICENCES_V" ("MEMBER_ID", "PROFILE_YEAR", "LICENCE") AS 
  select rp.member_id, rp.profile_year, rp.licence
from regatta_profiles rp
where rp.profile_year = (select max(profile_year) from regatta_profiles where member_id = rp.member_id)
;
--------------------------------------------------------
...
f.entrance_fee,
ycc.get_annual_fee(f.annual_fee,ma.membership) annual_fee,
lr.key,
il.coursefee,
il.course_name,
ma.PRINT_RECEIVED  
...
ycc.get_annual_fee(f.annual_fee, m.new_membership) annual_fee,
lr.key,
il.coursefee,
il.course_name,
...
--------------------------------------------------------
 ...
 TO_CHAR(R.DELETED, 'DD MON YY HH24:MM:SS') AS DELETED, TO_CHAR(R.MODIFIED,  'DD-MON-YY HH24:MM:SS') AS MODIFIED
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."BOAT_KEYS_PK" ON "YCC"."BOAT_KEYS" ("KEY_NR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."BOAT_KEYS_UK1" ON "YCC"."BOAT_KEYS" ("BOAT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."DOCUMENT_TYPES_PK" ON "YCC"."DOCUMENT_TYPES" ("DOCUMENT_TYPE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."PK_FEESRECORDS" ON "YCC"."FEESRECORDS" ("PAYMENTID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."PK_YCCLOG" ON "YCC"."YCCLOG" ("LOG_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."feesrecords_HIST_PK" ON "YCC"."FEESRECORDS_HIST" ("PAYMENTID", "CREATE_TIME_UTC") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."HELPERS_APP_PERMISSIONS_PK" ON "YCC"."HELPERS_APP_PERMISSIONS" ("MEMBER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."HELPER_TASKS_PK" ON "YCC"."HELPER_TASKS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."MD_APPLICATIONFILES_PK" ON "YCC"."MD_APPLICATIONFILES" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."MD_FILE_ARTIFACTS_PK" ON "YCC"."MD_FILE_ARTIFACTS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "DATA02" ;
--------------------------------------------------------
--  DDL for Index MEMBER_ROLES_OK
--------------------------------------------------------

  CREATE UNIQUE INDEX "YCC"."MEMBER_ROLES_OK" ON "YCC"."MEMBER_ROLES" ("MEMBER_ROLE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "YCC"."YCCLOG_INDEX1" ON "YCC"."YCCLOG" ("CREATED" DESC) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "YCC"."MD_STATE_TYPE__ID" ON "YCC"."MD_APPLICATIONFILES" ("STATE", "TYPE", "ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "YCC"."DOCUMENT_TYPES_DOCUMENT_TYPE_NAME_UK" ON "YCC"."DOCUMENT_TYPES" (UPPER("DOCUMENT_TYPE_NAME")) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."FEESRECORDS_EDITED" 
...
END;
/
ALTER TRIGGER "YCC"."FEESRECORDS_EDITED" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."HELPER_TASK_HELPERS_CHECK_CANNOT_BE_HELPER_IF_ALREADY_CAPTAIN" 
...
/
ALTER TRIGGER "YCC"."HELPER_TASK_HELPERS_CHECK_CANNOT_BE_HELPER_IF_ALREADY_CAPTAIN" ENABLE;
--------------------------------------------------------
--  DDL for Trigger HELPER_TASK_HELPERS_CHECK_NO_MORE_HELPERS_THAN_MAX_HELPER_COUNT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."HELPER_TASK_HELPERS_CHECK_NO_MORE_HELPERS_THAN_MAX_HELPER_COUNT" 
...
/
ALTER TRIGGER "YCC"."HELPER_TASK_HELPERS_CHECK_NO_MORE_HELPERS_THAN_MAX_HELPER_COUNT" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."HOLIDAYS_EDITED" 
...
END;
/
ALTER TRIGGER "YCC"."HOLIDAYS_EDITED" ENABLE;
--------------------------------------------------------
--  DDL for Trigger HOLIDAYS_ID_TRIGGER
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."HOLIDAYS_ID_TRIGGER" 
...
/
ALTER TRIGGER "YCC"."HOLIDAYS_ID_TRIGGER" ENABLE;
--------------------------------------------------------
--  DDL for Trigger LICENCES_EDITED
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."LICENCES_EDITED" 
...
END;
/
ALTER TRIGGER "YCC"."LICENCES_EDITED" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."MEMBERSHIP_APPLICATIONS_HIST" for insert or update or delete on membership_applications
compound trigger
...
/
ALTER TRIGGER "YCC"."MEMBERSHIP_APPLICATIONS_HIST" ENABLE;
--------------------------------------------------------
--  DDL for Trigger RESERVATIONS_EDITED
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."RESERVATIONS_EDITED" 
...
END;
/
ALTER TRIGGER "YCC"."RESERVATIONS_EDITED" ENABLE;
--------------------------------------------------------
--  DDL for Trigger RESERVATIONS_HIST
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."RESERVATIONS_HIST" for insert or update or delete on reservations
compound trigger
...
/
ALTER TRIGGER "YCC"."RESERVATIONS_HIST" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "YCC"."WEB_LOGON_EDITED" 
...
END;
/
ALTER TRIGGER "YCC"."WEB_LOGON_EDITED" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "YCC"."AUTHENTICATE_TEST" (p_username in varchar2, p_password in varchar2) return varchar2 as
...
--------------------------------------------------------
--  DDL for Function GET_ANNUAL_FEE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "YCC"."GET_ANNUAL_FEE" (annual_fee number, membership varchar2) return number as
  current_year number := get_current_membership_year();
begin

  if (membership = 'T' or membership = 'SV') then
    return annual_fee;
  end if;

  if TO_DATE(current_year || '-01-01', 'yyyy-mm-dd') < sysdate then
    if (membership = 'AJ' or membership = 'AS') then
       return annual_fee - 50;
    else
      return annual_fee - 80;
    end if;
  else
    return annual_fee;
  end if;
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."MD_APPLICATIONS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONS" MODIFY ("PROJECT_ID_FK" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONS" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONS" ADD CONSTRAINT "MD_APPLICATIONS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."AUDIT_LOG" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."AUDIT_LOG" MODIFY ("CREATED_AT" NOT NULL ENABLE);
  ALTER TABLE "YCC"."AUDIT_LOG" MODIFY ("APPLICATION" NOT NULL ENABLE);
  ALTER TABLE "YCC"."AUDIT_LOG" MODIFY ("PRINCIPAL" NOT NULL ENABLE);
  ALTER TABLE "YCC"."AUDIT_LOG" MODIFY ("DESCRIPTION" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."HT_WEB_LOGON" MODIFY ("MEMBER_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table INFOLICENCES
--------------------------------------------------------

  ALTER TABLE "YCC"."INFOLICENCES" MODIFY ("NLICENCE" NOT NULL ENABLE);
  ...
  ALTER TABLE "YCC"."INFOLICENCES" ADD CONSTRAINT "INFOLICENCES_UK1" UNIQUE ("NLICENCE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02"  ENABLE;
  ALTER TABLE "YCC"."INFOLICENCES" MODIFY ("HAS_TEST" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."FEESRECORDS_HIST" ADD CONSTRAINT "feesrecords_HIST_OPTYPE_CHK" CHECK ( op_type IN ( 'D', 'I', 'U' ) ) ENABLE;
  ALTER TABLE "YCC"."FEESRECORDS_HIST" ADD CONSTRAINT "feesrecords_HIST_PK" PRIMARY KEY ("PAYMENTID", "CREATE_TIME_UTC")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table BOAT_WARNING
--------------------------------------------------------

  ALTER TABLE "YCC"."BOAT_WARNING" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_WARNING" MODIFY ("BOAT_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_WARNING" MODIFY ("level" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_WARNING" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_WARNING" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_WARNING" MODIFY ("STATE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."BOAT_WARNING" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_MARKED_AS_DONE_FIELDS" CHECK ( (marked_as_done_at IS     NULL AND marked_as_done_by_id IS     NULL)
             OR (marked_as_done_at IS NOT NULL AND marked_as_done_by_id IS NOT NULL) ) ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_VALIDATED_FIELDS" CHECK ( (validated_at IS     NULL AND validated_by_id IS     NULL)
             OR (validated_at IS NOT NULL AND validated_by_id IS NOT NULL) ) ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASKS" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASKS" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASKS" MODIFY ("SHORT_DESCRIPTION" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASKS" MODIFY ("CONTACT_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASKS" MODIFY ("URGENT" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASKS" MODIFY ("HELPER_MIN_COUNT" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASKS" MODIFY ("HELPER_MAX_COUNT" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASKS" MODIFY ("PUBLISHED" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "DATA02"  ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_TIMING" CHECK ("STARTS_AT" IS NOT NULL AND "ENDS_AT" IS NOT NULL AND "DEADLINE" IS NULL AND "STARTS_AT"<"ENDS_AT" OR "STARTS_AT" IS NULL AND "ENDS_AT" IS NULL AND "DEADLINE" IS NOT NULL) ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_CAPTAIN_FIELDS" CHECK ("CAPTAIN_ID" IS NULL AND "CAPTAIN_SIGNED_UP_AT" IS NULL OR "CAPTAIN_ID" IS NOT NULL AND "CAPTAIN_SIGNED_UP_AT" IS NOT NULL) ENABLE;
  ALTER TABLE "YCC"."HELPER_TASKS" ADD CONSTRAINT "HELPER_TASKS_CHECK_HELPER_MIN_MAX_COUNT" CHECK (0<="HELPER_MIN_COUNT" AND "HELPER_MIN_COUNT"<="HELPER_MAX_COUNT") ENABLE;
--------------------------------------------------------
--  Constraints for Table HELPER_TASK_HELPERS
--------------------------------------------------------

  ALTER TABLE "YCC"."HELPER_TASK_HELPERS" MODIFY ("TASK_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASK_HELPERS" MODIFY ("MEMBER_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASK_HELPERS" MODIFY ("SIGNED_UP_AT" NOT NULL ENABLE);
  ALTER TABLE "YCC"."HELPER_TASK_HELPERS" ADD CONSTRAINT "HELPER_TASK_HELPERS_PK" PRIMARY KEY ("TASK_ID", "MEMBER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."RESERVATIONS_HIST" ADD CONSTRAINT "RESERVATIONS_HIST_OPTYPE_CHK" CHECK ( op_type IN ( 'D', 'I', 'U' ) ) ENABLE;
  ALTER TABLE "YCC"."RESERVATIONS_HIST" ADD CONSTRAINT "RESERVATIONS_HIST_PK" PRIMARY KEY ("RES_ID", "CREATE_TIME_UTC")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."FEESRECORDS" ADD CONSTRAINT "PK_FEESRECORDS" PRIMARY KEY ("PAYMENTID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."INFOLICENCES_BACKUP" MODIFY ("INFOID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."INFOLICENCES_BACKUP" MODIFY ("DESCRIPTION" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."FEES" ADD CONSTRAINT "CHECK_CAT" CHECK (cat_id in ('AS','AJ','FM','H','C','T')) DISABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."ATTACHMENT" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."ATTACHMENT" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "YCC"."ATTACHMENT" MODIFY ("CONTENT" NOT NULL ENABLE);
  ALTER TABLE "YCC"."ATTACHMENT" MODIFY ("MIME_TYPE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."ATTACHMENT" MODIFY ("SIZE_BYTES" NOT NULL ENABLE);
  ALTER TABLE "YCC"."ATTACHMENT" MODIFY ("OWNER_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."ATTACHMENT" MODIFY ("CREATED" NOT NULL ENABLE);
  ALTER TABLE "YCC"."ATTACHMENT" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."MEMBER_ROLES" MODIFY ("MEMBER_ID" CONSTRAINT "MEMBER_ROLES_MEMBER_ID_NN" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MEMBER_ROLES" MODIFY ("ROLE" CONSTRAINT "MEMBER_ROLES_ROLE_NN" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MEMBER_ROLES" ADD CONSTRAINT "MEMBER_ROLES_OK" PRIMARY KEY ("MEMBER_ROLE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."STATUS" ADD CONSTRAINT "STATUS_PK" PRIMARY KEY ("STAT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."MD_APPLICATIONFILES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONFILES" MODIFY ("APPLICATIONS_ID_FK" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONFILES" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONFILES" MODIFY ("URI" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONFILES" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONFILES" MODIFY ("STATE" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONFILES" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONFILES" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "YCC"."MD_APPLICATIONFILES" ADD CONSTRAINT "MD_APPLICATIONFILES_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "DATA02"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."ATTACHMENT" ADD FOREIGN KEY ("OWNER_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."BOAT_MAINTAINER" ADD FOREIGN KEY ("MEMBER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BOAT_WARNING
--------------------------------------------------------

  ALTER TABLE "YCC"."BOAT_WARNING" ADD FOREIGN KEY ("BOAT_ID")
	  REFERENCES "YCC"."BOATS" ("BOAT_ID") ENABLE;
  ALTER TABLE "YCC"."BOAT_WARNING" ADD FOREIGN KEY ("CREATED_BY")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
  ALTER TABLE "YCC"."BOAT_WARNING" ADD FOREIGN KEY ("PARENT_ID")
	  REFERENCES "YCC"."BOAT_WARNING" ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "YCC"."LICENCES" ADD FOREIGN KEY ("MEMBER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table MEMBER_ROLES
--------------------------------------------------------

  ALTER TABLE "YCC"."MEMBER_ROLES" ADD CONSTRAINT "MEMBER_ROLES_MEMBER_ID_FK" FOREIGN KEY ("MEMBER_ID")
	  REFERENCES "YCC"."MEMBERS" ("ID") ENABLE;
--------------------------------------------------------
